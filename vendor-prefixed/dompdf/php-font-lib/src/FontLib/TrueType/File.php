...
use Onepix\FoodSpotVendor\FontLib\AdobeFontMetrics;
use Onepix\FoodSpotVendor\FontLib\Font;
...
use Onepix\FoodSpotVendor\FontLib\Table\Type\name;
use Onepix\FoodSpotVendor\FontLib\Table\Type\nameRecord;
...
class File extends BinaryStream {
    ...
    protected function readTable($tag) {
        ...
        if (!self::$raw) {
            ...
            $class = "Onepix\\FoodSpotVendor\\FontLib\\Table\\Type\\$name_canon";
            ...
            $class = "Onepix\\FoodSpotVendor\\FontLib\\Table\\Table";
        }
