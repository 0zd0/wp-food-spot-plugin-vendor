...
namespace Onepix\FoodSpotVendor\Svg\Surface;

use Onepix\FoodSpotVendor\Svg\Document;
...
class SurfaceCpdf implements SurfaceInterface
{
    ...
    /** @var \Onepix\FoodSpotVendor\Svg\Surface\CPdf */
    private $canvas;
    ...
    public function __construct(Document $doc, $canvas = null)
    {
        ...
        if (!$canvas) {
            $canvas = new \Onepix\FoodSpotVendor\Svg\Surface\CPdf(array(0, 0, $w, $h));
