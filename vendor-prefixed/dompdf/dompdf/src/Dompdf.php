...
use Onepix\FoodSpotVendor\Dompdf\Frame\FrameTree;
use Onepix\FoodSpotVendor\Dompdf\Image\Cache;
use Onepix\FoodSpotVendor\Dompdf\Css\Stylesheet;
use Onepix\FoodSpotVendor\Dompdf\Helpers;
use Onepix\FoodSpotVendor\Masterminds\HTML5;
...
class Dompdf
{
    ...
    */
    ...
    /**
     * Return the underlying Canvas instance (e.g. Onepix\FoodSpotVendor\Dompdf\Adapter\CPDF, Onepix\FoodSpotVendor\Dompdf\Adapter\GD)
     *
     * @return Canvas
     */
