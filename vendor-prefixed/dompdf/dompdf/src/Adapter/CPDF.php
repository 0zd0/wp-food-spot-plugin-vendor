...
namespace Onepix\FoodSpotVendor\Dompdf\Adapter;

use Onepix\FoodSpotVendor\Dompdf\Canvas;
use Onepix\FoodSpotVendor\Dompdf\Dompdf;
use Onepix\FoodSpotVendor\Dompdf\Exception;
use Onepix\FoodSpotVendor\Dompdf\FontMetrics;
use Onepix\FoodSpotVendor\Dompdf\Helpers;
use Onepix\FoodSpotVendor\Dompdf\Image\Cache;
use Onepix\FoodSpotVendor\FontLib\Exception\FontNotFoundException;
/**
...
class CPDF implements Canvas
{
     ...
     *
     * @var \Onepix\FoodSpotVendor\Dompdf\Cpdf
     */
    protected $_pdf;
    /**
     * PDF width, in points
    ...
    public function __construct($paper = "letter", string $orientation = "portrait", ?Dompdf $dompdf = null)
    {
        ...
        $this->_pdf = new \Onepix\FoodSpotVendor\Dompdf\Cpdf($size, true, $this->_dompdf->getOptions()->getFontCache(), $this->_dompdf->getOptions()->getTempDir());
     ...
     *
     * @return \Onepix\FoodSpotVendor\Dompdf\Cpdf
     */
    ...
    public function select($x, $y, $w, $h, $font, $size, $color = [0, 0, 0], $opts = [])
    {
        ...
        $ft = \Onepix\FoodSpotVendor\Dompdf\Cpdf::ACROFORM_FIELD_CHOICE;
        $ff = \Onepix\FoodSpotVendor\Dompdf\Cpdf::ACROFORM_FIELD_CHOICE_COMBO;
    ...
    public function textarea($x, $y, $w, $h, $font, $size, $color = [0, 0, 0])
    {
        ...
        $ft = \Onepix\FoodSpotVendor\Dompdf\Cpdf::ACROFORM_FIELD_TEXT;
        $ff = \Onepix\FoodSpotVendor\Dompdf\Cpdf::ACROFORM_FIELD_TEXT_MULTILINE;
    ...
    public function input($x, $y, $w, $h, $type, $font, $size, $color = [0, 0, 0])
    {
        ...
        switch ($type) {
            ...
            case 'password':
                $ft = \Onepix\FoodSpotVendor\Dompdf\Cpdf::ACROFORM_FIELD_TEXT;
                $ff = \Onepix\FoodSpotVendor\Dompdf\Cpdf::ACROFORM_FIELD_TEXT_PASSWORD;
                break;
            case 'submit':
                $ft = \Onepix\FoodSpotVendor\Dompdf\Cpdf::ACROFORM_FIELD_BUTTON;
                break;
        }
        $pdf->addFormField($ft, rand(), $x, $this->y($y) - $h, $x + $w, $this->y($y), $ff, $size, $color);
    }
