...
use Onepix\FoodSpotVendor\Dompdf\FrameDecorator\Page as PageFrameDecorator;
use Onepix\FoodSpotVendor\Dompdf\FrameReflower\Page as PageFrameReflower;
use Onepix\FoodSpotVendor\Dompdf\Positioner\AbstractPositioner;
use DOMXPath;
/**
...
class Factory
{
    ...
    public static function decorate_frame(Frame $frame, Dompdf $dompdf, ?Frame $root = null): ?AbstractFrameDecorator
    {
        ...
        $decorator = "Onepix\\FoodSpotVendor\\Dompdf\\FrameDecorator\\{$decorator}";
        $reflower = "Onepix\\FoodSpotVendor\\Dompdf\\FrameReflower\\{$reflower}";
    ...
    protected static function getPositionerInstance(string $type): AbstractPositioner
    {
        if (!isset(self::$_positioners[$type])) {
            $class = '\Onepix\FoodSpotVendor\Dompdf\Positioner\\' . $type;
