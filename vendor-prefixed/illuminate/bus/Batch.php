...
use Closure;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Queue\Factory as QueueFactory;
...
class Batch implements Arrayable, JsonSerializable
{
     ...
     *
     * @var \Onepix\FoodSpotVendor\Illuminate\Contracts\Queue\Factory
     */
    protected $queue;
     ...
     *
     * @var \Onepix\FoodSpotVendor\Carbon\CarbonImmutable
     */
    public $createdAt;
     ...
     *
     * @var \Onepix\FoodSpotVendor\Carbon\CarbonImmutable|null
     */
    public $cancelledAt;
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Queue\Factory  $queue
     * @param  \Onepix\FoodSpotVendor\Illuminate\Bus\BatchRepository  $repository
     * @param  string  $id
     * @param  string  $name
     * @param  int  $totalJobs
     ...
     * @param  array  $options
     * @param  \Onepix\FoodSpotVendor\Carbon\CarbonImmutable  $createdAt
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Support\Enumerable|object|array  $jobs
     * @return self
     */
    public function add($jobs)
    {
        ...
        $jobs = Collection::wrap($jobs)->map(function ($job) use (&$count) {
            ...
            if (is_array($job)) {
                ...
                return onepix_foodspotvendor_with($this->prepareBatchedChain($job), function ($chain) {
                    return $chain->first()
     ...
     *
     * @param  string  $jobId
     * @return \Onepix\FoodSpotVendor\Illuminate\Bus\UpdatedBatchJobCounts
     */
