...
use Onepix\FoodSpotVendor\Illuminate\Database\PostgresConnection;
...
class DatabaseBatchRepository implements PrunableBatchRepository
{
     ...
     *
     * @var \Onepix\FoodSpotVendor\Illuminate\Bus\BatchFactory
     */
    protected $factory;
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Bus\BatchFactory  $factory
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Bus\PendingBatch  $batch
     * @return \Onepix\FoodSpotVendor\Illuminate\Bus\Batch
     */
    ...
    protected function updateAtomicValues(string $batchId, Closure $callback)
    {
        return $this->connection->transaction(function () use ($batchId, $callback) {
            ...
            return is_null($batch) ? [] : onepix_foodspotvendor_tap($callback($batch), function ($values) use ($batchId) {
