...
class Number
{
    ...
    public static function withLocale(string $locale, callable $callback)
    {
        ...
        return onepix_foodspotvendor_tap($callback(), fn () => static::useLocale($previousLocale));
    }
    ...
    public static function withCurrency(string $currency, callable $callback)
    {
        ...
        return onepix_foodspotvendor_tap($callback(), fn () => static::useCurrency($previousCurrency));
    }
