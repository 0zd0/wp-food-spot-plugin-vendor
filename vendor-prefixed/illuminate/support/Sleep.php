...
class Sleep
{
     ...
     *
     * @var \Onepix\FoodSpotVendor\Carbon\CarbonInterval
     */
    public $duration;
     ...
     *
     * @var array<int, \Onepix\FoodSpotVendor\Carbon\CarbonInterval>
     */
    ...
    protected function pullPending()
    {
        ...
        return onepix_foodspotvendor_tap($this->pending, function () {
            $this->pending = null;
        });
    }
    ...
    {
        return $this->when(! onepix_foodspotvendor_value($condition, $this));
    }
