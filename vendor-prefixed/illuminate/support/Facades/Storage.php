...
/**
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\Filesystem\Filesystem drive(string|null $name = null)
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\Filesystem\Filesystem disk(string|null $name = null)
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\Filesystem\Cloud cloud()
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\Filesystem\Filesystem build(string|array $config)
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\Filesystem\Filesystem createLocalDriver(array $config, string $name = 'local')
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\Filesystem\Filesystem createFtpDriver(array $config)
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\Filesystem\Filesystem createSftpDriver(array $config)
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\Filesystem\Cloud createS3Driver(array $config)
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\Filesystem\Filesystem createScopedDriver(array $config)
 ...
 * @method static \Illuminate\Filesystem\FilesystemManager setApplication(\Onepix\FoodSpotVendor\Illuminate\Contracts\Foundation\Application $app)
 * @method static string path(string $path)
 * @method static bool exists(string $path)
 * @method static string|null get(string $path)
 * @method static resource|null readStream(string $path)
 * @method static bool put(string $path, \Onepix\FoodSpotVendor\Psr\Http\Message\StreamInterface|\Illuminate\Http\File|\Illuminate\Http\UploadedFile|string|resource $contents, mixed $options = [])
 ...
 * @method static \Illuminate\Filesystem\FilesystemAdapter|mixed onepix_foodspotvendor_when(\Closure|mixed|null $value = null, callable|null $callback = null, callable|null $default = null)
...
class Storage extends Facade
{
    ...
    public static function fake($disk = null, array $config = [])
    {
        ...
        return onepix_foodspotvendor_tap($fake)->buildTemporaryUrlsUsing(function ($path, $expiration) {
