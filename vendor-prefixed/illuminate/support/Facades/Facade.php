...
use Onepix\FoodSpotVendor\Illuminate\Support\Js;
use Onepix\FoodSpotVendor\Illuminate\Support\Number;
use Onepix\FoodSpotVendor\Illuminate\Support\Str;
use Onepix\FoodSpotVendor\Illuminate\Support\Testing\Fakes\Fake;
use Onepix\FoodSpotVendor\Illuminate\Support\Uri;
use Mockery;
...
abstract class Facade
{
     ...
     *
     * @var \Onepix\FoodSpotVendor\Illuminate\Contracts\Foundation\Application|null
     */
    ...
    public static function spy()
    {
        if (! static::isMock()) {
            ...
            return onepix_foodspotvendor_tap($class ? Mockery::spy($class) : Mockery::spy(), function ($spy) {
                static::swap($spy);
            });
        }
    }
    ...
    {
        return onepix_foodspotvendor_tap(static::createMock(), function ($mock) {
            static::swap($mock);
     ...
     *
     * @return \Onepix\FoodSpotVendor\Illuminate\Contracts\Foundation\Application|null
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Foundation\Application|null  $app
     * @return void
     */
