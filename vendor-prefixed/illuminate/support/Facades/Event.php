...
use Onepix\FoodSpotVendor\Illuminate\Support\Testing\Fakes\EventFake;

/**
 * @method static void listen(\Onepix\FoodSpotVendor\Illuminate\Events\QueuedClosure|callable|array|string $events, \Onepix\FoodSpotVendor\Illuminate\Events\QueuedClosure|callable|array|string|null $listener = null)
 ...
 * @method static \Onepix\FoodSpotVendor\Illuminate\Events\Dispatcher setQueueResolver(callable $resolver)
 * @method static \Onepix\FoodSpotVendor\Illuminate\Events\Dispatcher setTransactionManagerResolver(callable $resolver)
 * @method static array getRawListeners()
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 * @method static \Onepix\FoodSpotVendor\Illuminate\Support\Testing\Fakes\EventFake except(array|string $eventsToDispatch)
 ...
 * @method static \Onepix\FoodSpotVendor\Illuminate\Support\Collection dispatched(string $event, callable|null $callback = null)
 * @method static bool hasDispatched(string $event)
 * @method static array dispatchedEvents()
 *
 * @see \Onepix\FoodSpotVendor\Illuminate\Events\Dispatcher
 * @see \Onepix\FoodSpotVendor\Illuminate\Support\Testing\Fakes\EventFake
 */
class Event extends Facade
{
     ...
     * @return \Onepix\FoodSpotVendor\Illuminate\Support\Testing\Fakes\EventFake
     */
    public static function fake($eventsToFake = [])
    {
        ...
        return onepix_foodspotvendor_tap(new EventFake($actualDispatcher, $eventsToFake), function ($fake) {
            static::swap($fake);
    ...
    public static function fakeFor(callable $callable, array $eventsToFake = [])
    {
        ...
        return onepix_foodspotvendor_tap($callable(), function () use ($originalDispatcher) {
