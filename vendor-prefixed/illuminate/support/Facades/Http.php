 ...
 * @method static \Onepix\FoodSpotVendor\GuzzleHttp\Promise\PromiseInterface response(array|string|null $body = null, int $status = 200, array $headers = [])
 * @method static \Onepix\FoodSpotVendor\GuzzleHttp\Promise\PromiseInterface failedConnection(string|null $message = null)
 ...
 * @method static \Onepix\FoodSpotVendor\Illuminate\Support\Collection recorded(callable $callback = null)
 * @method static \Illuminate\Http\Client\PendingRequest createPendingRequest()
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\Events\Dispatcher|null getDispatcher()
 ...
 * @method static \Illuminate\Http\Client\PendingRequest withBody(\Onepix\FoodSpotVendor\Psr\Http\Message\StreamInterface|string $content, string $contentType = 'application/json')
 ...
 * @method static \Onepix\FoodSpotVendor\GuzzleHttp\Client buildClient()
 * @method static \Onepix\FoodSpotVendor\GuzzleHttp\Client createClient(\Onepix\FoodSpotVendor\GuzzleHttp\HandlerStack $handlerStack)
 * @method static \Onepix\FoodSpotVendor\GuzzleHttp\HandlerStack buildHandlerStack()
 * @method static \Onepix\FoodSpotVendor\GuzzleHttp\HandlerStack pushHandlers(\Onepix\FoodSpotVendor\GuzzleHttp\HandlerStack $handlerStack)
 * @method static \Closure buildBeforeSendingHandler()
 * @method static \Closure buildRecorderHandler()
 * @method static \Closure buildStubHandler()
 * @method static \Onepix\FoodSpotVendor\GuzzleHttp\Psr7\RequestInterface runBeforeSendingCallbacks(\Onepix\FoodSpotVendor\GuzzleHttp\Psr7\RequestInterface $request, array $options)
 * @method static array mergeOptions(array ...$options)
 * @method static \Illuminate\Http\Client\PendingRequest stub(callable $callback)
 * @method static \Illuminate\Http\Client\PendingRequest async(bool $async = true)
 * @method static \Onepix\FoodSpotVendor\GuzzleHttp\Promise\PromiseInterface|null getPromise()
...
class Http extends Facade
{
    ...
    {
        return onepix_foodspotvendor_tap(static::getFacadeRoot(), function ($fake) use ($callback) {
    ...
    {
        $fake = onepix_foodspotvendor_tap(static::getFacadeRoot(), function ($fake) {
            static::swap($fake);
        });
    ...
    {
        return onepix_foodspotvendor_tap(static::getFacadeRoot(), function ($fake) use ($prevent) {
     ...
     *
     * @param  string  $url
     * @param  \Illuminate\Http\Client\Response|\Onepix\FoodSpotVendor\GuzzleHttp\Promise\PromiseInterface|callable  $callback
     * @return \Illuminate\Http\Client\Factory
     */
    public static function stubUrl($url, $callback)
    {
        return onepix_foodspotvendor_tap(static::getFacadeRoot(), function ($fake) use ($url, $callback) {
