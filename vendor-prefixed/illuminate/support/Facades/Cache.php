...
/**
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\Cache\Repository store(string|null $name = null)
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\Cache\Repository driver(string|null $driver = null)
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\Cache\Repository resolve(string $name)
 * @method static \Illuminate\Cache\Repository build(array $config)
 * @method static \Illuminate\Cache\Repository repository(\Onepix\FoodSpotVendor\Illuminate\Contracts\Cache\Store $store, array $config = [])
 ...
 * @method static \Illuminate\Cache\CacheManager setApplication(\Onepix\FoodSpotVendor\Illuminate\Contracts\Foundation\Application $app)
 ...
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\Cache\Store getStore()
 * @method static \Illuminate\Cache\Repository setStore(\Onepix\FoodSpotVendor\Illuminate\Contracts\Cache\Store $store)
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\Events\Dispatcher|null getEventDispatcher()
 * @method static void setEventDispatcher(\Onepix\FoodSpotVendor\Illuminate\Contracts\Events\Dispatcher $events)
 ...
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\Cache\Lock lock(string $name, int $seconds = 0, string|null $owner = null)
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\Cache\Lock restoreLock(string $name, string $owner)
 *
