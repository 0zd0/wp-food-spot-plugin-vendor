 ...
 * @method static \Onepix\FoodSpotVendor\Illuminate\Support\ServiceProvider register(\Onepix\FoodSpotVendor\Illuminate\Support\ServiceProvider|string $provider, bool $force = false)
 * @method static \Onepix\FoodSpotVendor\Illuminate\Support\ServiceProvider|null getProvider(\Onepix\FoodSpotVendor\Illuminate\Support\ServiceProvider|string $provider)
 * @method static array getProviders(\Onepix\FoodSpotVendor\Illuminate\Support\ServiceProvider|string $provider)
 * @method static \Onepix\FoodSpotVendor\Illuminate\Support\ServiceProvider resolveProvider(string $provider)
 ...
 * @method static int handleCommand(\Onepix\FoodSpotVendor\Symfony\Component\Console\Input\InputInterface $input)
 ...
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\Foundation\MaintenanceMode maintenanceMode()
 ...
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\Container\Container|\Illuminate\Foundation\Application setInstance(\Onepix\FoodSpotVendor\Illuminate\Contracts\Container\Container|null $container = null)
