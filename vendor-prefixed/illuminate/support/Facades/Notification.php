...
use Onepix\FoodSpotVendor\Illuminate\Support\Testing\Fakes\NotificationFake;

/**
 * @method static void send(\Onepix\FoodSpotVendor\Illuminate\Support\Collection|array|mixed $notifiables, mixed $notification)
 * @method static void sendNow(\Onepix\FoodSpotVendor\Illuminate\Support\Collection|array|mixed $notifiables, mixed $notification, array|null $channels = null)
 ...
 * @method static \Illuminate\Notifications\ChannelManager setContainer(\Onepix\FoodSpotVendor\Illuminate\Contracts\Container\Container $container)
 ...
 * @method static \Onepix\FoodSpotVendor\Illuminate\Support\Collection sent(mixed $notifiable, string $notification, callable|null $callback = null)
 * @method static bool hasSent(mixed $notifiable, string $notification)
 * @method static \Onepix\FoodSpotVendor\Illuminate\Support\Testing\Fakes\NotificationFake serializeAndRestore(bool $serializeAndRestore = true)
 ...
 * @see \Onepix\FoodSpotVendor\Illuminate\Support\Testing\Fakes\NotificationFake
 */
class Notification extends Facade
{
     ...
     *
     * @return \Onepix\FoodSpotVendor\Illuminate\Support\Testing\Fakes\NotificationFake
     */
    public static function fake()
    {
        return onepix_foodspotvendor_tap(new NotificationFake, function ($fake) {
            static::swap($fake);
        });
    }
