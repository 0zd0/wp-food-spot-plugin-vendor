...
/**
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\View\View file(string $path, \Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\View\View make(string $view, \Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\View\View first(array $views, \Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderWhen(bool $condition, string $view, \Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderUnless(bool $condition, string $view, \Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderEach(string $view, array $data, string $iterator, string $empty = 'raw|')
 * @method static bool exists(string $view)
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\View\Engine getEngineFromPath(string $path)
 ...
 * @method static \Onepix\FoodSpotVendor\Illuminate\Contracts\Container\Container getContainer()
 * @method static void setContainer(\Onepix\FoodSpotVendor\Illuminate\Contracts\Container\Container $container)
 ...
 * @method static void startComponent(\Onepix\FoodSpotVendor\Illuminate\Contracts\View\View|\Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Htmlable|\Closure|string $view, array $data = [])
 ...
 * @method static void callComposer(\Onepix\FoodSpotVendor\Illuminate\Contracts\View\View $view)
 * @method static void callCreator(\Onepix\FoodSpotVendor\Illuminate\Contracts\View\View $view)
