 ...
 * @method static \Illuminate\Routing\Router setContainer(\Onepix\FoodSpotVendor\Illuminate\Container\Container $container)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 * @method static mixed macroCall(string $method, array $parameters)
 * @method static \Onepix\FoodSpotVendor\Illuminate\Support\HigherOrderTapProxy|\Illuminate\Routing\Router onepix_foodspotvendor_tap(callable|null $callback = null)
