...
use Closure;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Mail\Factory;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Mail\Mailable;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Mail\Mailer;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Mail\MailQueue;
...
class MailFake implements Factory, Fake, Mailer, MailQueue
{
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Mail\Mailable|string|array  $view
     * @param  array  $data
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Mail\Mailable|string|array  $mailable
     * @param  array  $data
     * @param  \Closure|string|null  $callback
     * @return void
     */
