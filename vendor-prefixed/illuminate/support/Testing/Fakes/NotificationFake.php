...
use Closure;
use Exception;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Notifications\Dispatcher as NotificationDispatcher;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Notifications\Factory as NotificationFactory;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Queue\ShouldQueue;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Translation\HasLocalePreference;
...
class NotificationFake implements Fake, NotificationDispatcher, NotificationFactory
{
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Support\Collection|array|mixed  $notifiables
    ...
    public function sendNow($notifiables, $notification, ?array $channels = null)
    {
        ...
        foreach ($notifiables as $notifiable) {
            ...
            $this->notifications[get_class($notifiable)][$notifiable->getKey()][get_class($notification)][] = [
                ...
                'locale' => $notification->locale ?? $this->locale ?? onepix_foodspotvendor_value(function () use ($notifiable) {
