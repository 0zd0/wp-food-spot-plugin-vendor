...
use Onepix\FoodSpotVendor\Illuminate\Support\Traits\InteractsWithData;
 ...
 * @template TValue
 *
 * @implements \Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable<TKey, TValue>
...
class Fluent implements Arrayable, ArrayAccess, Jsonable, JsonSerializable
{
    ...
    {
        return onepix_foodspotvendor_data_get($this->attributes, $key, $default);
    }
    ...
    {
        onepix_foodspotvendor_data_set($this->attributes, $key, $value);
