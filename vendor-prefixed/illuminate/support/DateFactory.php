...
use Onepix\FoodSpotVendor\Carbon\Factory;
 ...
 *
 * @method \Onepix\FoodSpotVendor\Illuminate\Support\Carbon create($year = 0, $month = 1, $day = 1, $hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \Onepix\FoodSpotVendor\Illuminate\Support\Carbon createFromDate($year = null, $month = null, $day = null, $tz = null)
 * @method \Onepix\FoodSpotVendor\Illuminate\Support\Carbon|false createFromFormat($format, $time, $tz = null)
 * @method \Onepix\FoodSpotVendor\Illuminate\Support\Carbon createFromTime($hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \Onepix\FoodSpotVendor\Illuminate\Support\Carbon createFromTimeString($time, $tz = null)
 * @method \Onepix\FoodSpotVendor\Illuminate\Support\Carbon createFromTimestamp($timestamp, $tz = null)
 * @method \Onepix\FoodSpotVendor\Illuminate\Support\Carbon createFromTimestampMs($timestamp, $tz = null)
 * @method \Onepix\FoodSpotVendor\Illuminate\Support\Carbon createFromTimestampUTC($timestamp)
 * @method \Onepix\FoodSpotVendor\Illuminate\Support\Carbon createMidnightDate($year = null, $month = null, $day = null, $tz = null)
 * @method \Onepix\FoodSpotVendor\Illuminate\Support\Carbon|false createSafe($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $tz = null)
 ...
 * @method \Onepix\FoodSpotVendor\Illuminate\Support\Carbon fromSerialized($value)
 ...
 * @method \Onepix\FoodSpotVendor\Illuminate\Support\Carbon|null getTestNow()
 * @method \Onepix\FoodSpotVendor\Symfony\Component\Translation\TranslatorInterface getTranslator()
 ...
 * @method \Onepix\FoodSpotVendor\Illuminate\Support\Carbon instance($date)
 ...
 * @method \Onepix\FoodSpotVendor\Illuminate\Support\Carbon|null make($var)
 * @method \Onepix\FoodSpotVendor\Illuminate\Support\Carbon maxValue()
 * @method \Onepix\FoodSpotVendor\Illuminate\Support\Carbon minValue()
 * @method void mixin($mixin)
 * @method \Onepix\FoodSpotVendor\Illuminate\Support\Carbon now($tz = null)
 * @method \Onepix\FoodSpotVendor\Illuminate\Support\Carbon parse($time = null, $tz = null)
 ...
 * @method void setTranslator(\Onepix\FoodSpotVendor\Symfony\Component\Translation\TranslatorInterface $translator)
 ...
 * @method \Onepix\FoodSpotVendor\Illuminate\Support\Carbon today($tz = null)
 * @method \Onepix\FoodSpotVendor\Illuminate\Support\Carbon tomorrow($tz = null)
 ...
 * @method \Onepix\FoodSpotVendor\Illuminate\Support\Carbon yesterday($tz = null)
 */
class DateFactory
{
    /**
