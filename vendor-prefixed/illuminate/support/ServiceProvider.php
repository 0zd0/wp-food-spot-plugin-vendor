...
use Onepix\FoodSpotVendor\Illuminate\Contracts\Foundation\CachesConfiguration;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Foundation\CachesRoutes;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Support\DeferrableProvider;
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Factory as ModelFactory;
...
abstract class ServiceProvider
{
    ...
    protected function optimizes(?string $optimize = null, ?string $clear = null, ?string $key = null)
    {
        ...
        if (empty($key)) {
            $key = onepix_foodspotvendor_class_basename(get_class($this));
        }
     ...
     *
     * @return \Onepix\FoodSpotVendor\Illuminate\Support\DefaultProviders
     */
