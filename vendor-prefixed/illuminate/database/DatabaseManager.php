...
use Onepix\FoodSpotVendor\Illuminate\Database\Connectors\ConnectionFactory;
use Onepix\FoodSpotVendor\Illuminate\Database\Events\ConnectionEstablished;
use Onepix\FoodSpotVendor\Illuminate\Support\Arr;
use Onepix\FoodSpotVendor\Illuminate\Support\Collection;
use Onepix\FoodSpotVendor\Illuminate\Support\ConfigurationUrlParser;
...
/**
 * @mixin \Onepix\FoodSpotVendor\Illuminate\Database\Connection
 */
class DatabaseManager implements ConnectionResolverInterface
{
     ...
     *
     * @var \Onepix\FoodSpotVendor\Illuminate\Database\Connectors\ConnectionFactory
     */
    protected $factory;
     ...
     *
     * @var array<string, \Onepix\FoodSpotVendor\Illuminate\Database\Connection>
     */
     ...
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Connectors\ConnectionFactory  $factory
     * @return void
     */
    ...
    public function connectUsing(string $name, array $config, bool $force = false)
    {
        ...
        return onepix_foodspotvendor_tap($connection, fn ($connection) => $this->connections[$name] = $connection);
    }
    ...
    public function usingConnection($name, callable $callback)
    {
        ...
        return onepix_foodspotvendor_tap($callback(), function () use ($previousName) {
     ...
     *
     * @return array<string, \Onepix\FoodSpotVendor\Illuminate\Database\Connection>
     */
