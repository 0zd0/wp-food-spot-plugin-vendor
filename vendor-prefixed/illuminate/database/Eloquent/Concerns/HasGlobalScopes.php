...
use Closure;
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Attributes\ScopedBy;
...
trait HasGlobalScopes
{
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Scope|(\Closure(\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<static>): mixed)|string  $scope
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Scope|(\Closure(\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<static>): mixed)|null  $implementation
     * @return mixed
     *
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Scope|string  $scope
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Scope|(\Closure(\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<static>): mixed)|null
     */
