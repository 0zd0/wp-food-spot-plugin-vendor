...
use Onepix\FoodSpotVendor\Brick\Math\Exception\MathException as BrickMathException;
use Onepix\FoodSpotVendor\Brick\Math\RoundingMode;
...
use Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Eloquent\CastsInboundAttributes;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable;
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Casts\AsArrayObject;
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Casts\AsCollection;
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Casts\AsEncryptedArrayObject;
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Casts\AsEncryptedCollection;
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Casts\AsEnumArrayObject;
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Casts\AsEnumCollection;
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Casts\Attribute;
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Casts\Json;
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\InvalidCastException;
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\JsonEncodingException;
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\MissingAttributeException;
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\Relation;
use Onepix\FoodSpotVendor\Illuminate\Database\LazyLoadingViolationException;
...
use Onepix\FoodSpotVendor\Illuminate\Support\Exceptions\MathException;
use Onepix\FoodSpotVendor\Illuminate\Support\Facades\Crypt;
use Onepix\FoodSpotVendor\Illuminate\Support\Facades\Date;
use Onepix\FoodSpotVendor\Illuminate\Support\Facades\Hash;
...
trait HasAttributes
{
     ...
     *
     * @var \Onepix\FoodSpotVendor\Illuminate\Contracts\Encryption\Encrypter|null
     */
     ...
     * @return null
     *
     * @throws \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\MissingAttributeException
     */
    ...
    protected function getRelationshipFromMethod($method)
    {
        ...
        return onepix_foodspotvendor_tap($relation->getResults(), function ($results) use ($method) {
    ...
    protected function ensureCastsAreStringValues($casts)
    {
        foreach ($casts as $attribute => $cast) {
            $casts[$attribute] = match (true) {
                is_array($cast) => onepix_foodspotvendor_value(function () use ($cast) {
                    if (count($cast) === 1) {
                        return $cast[0];
                    }
    ...
    {
        return onepix_foodspotvendor_tap($this->getArrayAttributeByKey($key), function (&$array) use ($path, $value) {
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Encryption\Encrypter|null  $encrypter
     * @return void
     */
     ...
     *
     * @return \Onepix\FoodSpotVendor\Illuminate\Contracts\Encryption\Encrypter
     */
     ...
     *
     * @param  mixed  $value
     * @return \Onepix\FoodSpotVendor\Illuminate\Support\Carbon
     */
     ...
     * @return bool
     *
     * @throws \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\InvalidCastException
     */
