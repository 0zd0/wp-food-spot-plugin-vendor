...
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Attributes\ObservedBy;
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model;
use Onepix\FoodSpotVendor\Illuminate\Events\NullDispatcher;
...
trait HasEvents
{
     ...
     *
     * @param  string  $event
     * @param  \Onepix\FoodSpotVendor\Illuminate\Events\QueuedClosure|callable|array|class-string  $callback
     * @return void
     */
