...
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Attributes\CollectedBy;
use ReflectionClass;
...
trait HasCollection
{
     ...
     *
     * @param  array<array-key, \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model>  $models
     * @return TCollection
     */
