 ...
 * @template TResult
 *
 * @extends \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\HasOneOrMany<TRelatedModel, TDeclaringModel, TResult>
 */
abstract class MorphOneOrMany extends HasOneOrMany
{
    ...
    {
        return onepix_foodspotvendor_last(explode('.', $this->morphType));
    }
