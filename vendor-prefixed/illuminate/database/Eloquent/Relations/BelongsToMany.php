...
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\ModelNotFoundException;
...
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\Concerns\InteractsWithPivotTable;
use Onepix\FoodSpotVendor\Illuminate\Database\Query\Grammars\MySqlGrammar;
 ...
 *
 * @extends \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\Relation<TRelatedModel, TDeclaringModel, \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Collection<int, TRelatedModel>>
 */
class BelongsToMany extends Relation
{
     ...
     *
     * @var array<string|\Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression>
     */
    ...
    protected function resolveTableName($table)
    {
        ...
        if (in_array(AsPivot::class, onepix_foodspotvendor_class_uses_recursive($model))) {
            $this->using($table);
        }
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<TRelatedModel>|null  $query
     * @return $this
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Collection<int, TRelatedModel>  $results
     ...
     *
     * @param  string|\Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression|array<string, string>  $column
     * @param  mixed  $value
     * @return $this
     *
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return ($id is (\Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Collection<int, TRelatedModel> : TRelatedModel)
     */
    ...
    public function createOrFirst(array $attributes = [], array $values = [], array $joining = [], $touch = true)
    {
        ...
        try {
            return onepix_foodspotvendor_tap($this->related->where($attributes)->first() ?? throw $e, function ($instance) use ($joining, $touch) {
                $this->getQuery()->withSavepointIfNeeded(fn () => $this->attach($instance, $joining, $touch));
            });
        } catch (UniqueConstraintViolationException $e) {
    ...
    {
        return onepix_foodspotvendor_tap($this->firstOrCreate($attributes, $values, $joining, $touch), function ($instance) use ($values) {
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return ($id is (\Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Collection<int, TRelatedModel> : TRelatedModel|null)
     */
     ...
     * @return TRelatedModel
     *
     * @throws \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\ModelNotFoundException<TRelatedModel>
     ...
     * @param  array  $columns
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Collection<int, TRelatedModel>
     */
     ...
     *     ? \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Collection<int, TRelatedModel>|TValue
    ...
    public function paginate($perPage = null, $columns = ['*'], $pageName = 'page', $page = null)
    {
        ...
        return onepix_foodspotvendor_tap($this->query->paginate($perPage, $columns, $pageName, $page), function ($paginator) {
    ...
    public function simplePaginate($perPage = null, $columns = ['*'], $pageName = 'page', $page = null)
    {
        ...
        return onepix_foodspotvendor_tap($this->query->simplePaginate($perPage, $columns, $pageName, $page), function ($paginator) {
            $this->hydratePivotRelation($paginator->items());
        });
    }
    ...
    public function cursorPaginate($perPage = null, $columns = ['*'], $cursorName = 'cursor', $cursor = null)
    {
        ...
        return onepix_foodspotvendor_tap($this->query->cursorPaginate($perPage, $columns, $cursorName, $cursor), function ($paginator) {
            $this->hydratePivotRelation($paginator->items());
        });
    }
     ...
     *
     * @param  int  $chunkSize
     * @return \Onepix\FoodSpotVendor\Illuminate\Support\LazyCollection<int, TRelatedModel>
     */
     ...
     *
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<TRelatedModel>
     */
     ...
     *
     * @return \Onepix\FoodSpotVendor\Illuminate\Support\Collection<int, int|string>
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<TRelatedModel>  $query
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<TDeclaringModel>  $parentQuery
     ...
     *
     * @param  string|\Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression  $column
     * @return string|\Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression
     */
