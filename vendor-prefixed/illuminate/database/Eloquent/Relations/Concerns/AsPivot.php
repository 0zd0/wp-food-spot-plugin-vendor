...
trait AsPivot
{
     ...
     *
     * @var \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model
     */
    public $pivotParent;
    ...
    public function delete()
    {
        ...
        return onepix_foodspotvendor_tap($this->getDeleteQuery()->delete(), function () {
            $this->exists = false;
    ...
    public function getTable()
    {
        if (! isset($this->table)) {
            $this->setTable(str_replace(
                '\\', '', Str::snake(Str::singular(onepix_foodspotvendor_class_basename($this)))
            ));
        }
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model|null  $related
     * @return $this
     */
