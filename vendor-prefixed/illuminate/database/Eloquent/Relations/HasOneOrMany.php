...
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\Concerns\SupportsInverseRelations;
 ...
 * @template TResult
 *
 * @extends \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\Relation<TRelatedModel, TDeclaringModel, TResult>
 */
abstract class HasOneOrMany extends Relation
{
    ...
    {
        return onepix_foodspotvendor_tap($this->related->newInstance($attributes), function ($instance) {
