 ...
 * @template TResult
 *
 * @extends \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\Relation<TRelatedModel, TIntermediateModel, TResult>
 */
abstract class HasOneOrManyThrough extends Relation
{
    ...
    {
        return in_array(SoftDeletes::class, onepix_foodspotvendor_class_uses_recursive($this->throughParent));
    }
