...
class PendingHasThroughRelationship
{
     ...
     *
     * @param  string|(callable(TIntermediateModel): (\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\HasOne<TRelatedModel, TIntermediateModel>|\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\HasMany<TRelatedModel, TIntermediateModel>|\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\MorphOneOrMany<TRelatedModel, TIntermediateModel>))  $callback
     * @return (
     *     $callback is string
     *     ? \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\HasManyThrough<\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model, TIntermediateModel, TDeclaringModel>|\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\HasOneThrough<\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model, TIntermediateModel, TDeclaringModel>
     *     : (
     *         TLocalRelationship is \Illuminate\Database\Eloquent\Relations\HasMany<TIntermediateModel, TDeclaringModel>
     *         ? \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\HasManyThrough<TRelatedModel, TIntermediateModel, TDeclaringModel>
     *         : (
     *              $callback is callable(TIntermediateModel): \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\HasMany<TRelatedModel, TIntermediateModel>
     *              ? \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\HasManyThrough<TRelatedModel, TIntermediateModel, TDeclaringModel>
     *              : \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\HasOneThrough<TRelatedModel, TIntermediateModel, TDeclaringModel>
     *         )
     *     )
     * )
     */
