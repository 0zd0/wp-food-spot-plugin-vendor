...
trait BroadcastsEvents
{
     ...
     *
     * @param  \Illuminate\Broadcasting\Channel|\Onepix\FoodSpotVendor\Illuminate\Contracts\Broadcasting\HasBroadcastChannel|array|null  $channels
    ...
    {
        return onepix_foodspotvendor_tap($this->newBroadcastableEvent($event), function ($event) {
     ...
     *
     * @param  string  $event
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\BroadcastableModelEventOccurred
     */
