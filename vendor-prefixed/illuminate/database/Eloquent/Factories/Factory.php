...
use Onepix\FoodSpotVendor\Illuminate\Contracts\Foundation\Application;
...
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\SoftDeletes;
use Onepix\FoodSpotVendor\Illuminate\Support\Carbon;
use Onepix\FoodSpotVendor\Illuminate\Support\Collection;
use Onepix\FoodSpotVendor\Illuminate\Support\Enumerable;
...
abstract class Factory
{
     ...
     *
     * @var \Onepix\FoodSpotVendor\Illuminate\Support\Collection
     */
    protected $states;
     ...
     * @param  \Onepix\FoodSpotVendor\Illuminate\Support\Collection|null  $states
     * @param  \Onepix\FoodSpotVendor\Illuminate\Support\Collection|null  $has
     * @param  \Onepix\FoodSpotVendor\Illuminate\Support\Collection|null  $for
     * @param  \Onepix\FoodSpotVendor\Illuminate\Support\Collection|null  $afterMaking
     * @param  \Onepix\FoodSpotVendor\Illuminate\Support\Collection|null  $afterCreating
     * @param  string|null  $connection
     * @param  \Onepix\FoodSpotVendor\Illuminate\Support\Collection|null  $recycle
     ...
     * @param  (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed>  $attributes
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model|null  $parent
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Collection<int, TModel>|TModel
     */
     ...
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model|null  $parent
     * @return \Closure(): (\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Collection<int, TModel>|TModel)
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Support\Collection<int, \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model>  $results
     * @return void
     */
    ...
    public function make($attributes = [], ?Model $parent = null)
    {
        ...
        if ($this->count === null) {
            return onepix_foodspotvendor_tap($this->makeInstance($parent), function ($instance) {
    ...
    protected function makeInstance(?Model $parent)
    {
        return Model::unguarded(function () use ($parent) {
            return onepix_foodspotvendor_tap($this->newModel($this->getExpandedAttributes($parent)), function ($instance) {
                if (isset($this->connection)) {
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Factories\Factory|\Onepix\FoodSpotVendor\Illuminate\Support\Collection|\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model|array  $factory
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Factories\Factory|\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model  $factory
     * @param  string|null  $relationship
     * @return static
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model|\Onepix\FoodSpotVendor\Illuminate\Support\Collection|array  $model
     * @return static
     */
     ...
     *
     * @param  \Closure(TModel, \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model|null): mixed  $callback
     * @return static
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Support\Collection  $instances
     * @return void
     */
    ...
    public function modelName()
    {
        ...
        $resolver = static::$modelNameResolvers[static::class] ?? static::$modelNameResolvers[self::class] ?? static::$modelNameResolver ?? function (self $factory) {
            ...
            $factoryBasename = Str::replaceLast('Factory', '', onepix_foodspotvendor_class_basename($factory));
     ...
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Factories\Factory<TClass>
     */
     ...
     *
     * @param  callable(class-string<\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model>): class-string<\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Factories\Factory>  $callback
     * @return void
     */
     ...
     *
     * @param  class-string<TClass>  $modelName
     * @return class-string<\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Factories\Factory<TClass>>
     */
    ...
    public function __call($method, $parameters)
    {
        ...
        if ($method === 'trashed' && in_array(SoftDeletes::class, onepix_foodspotvendor_class_uses_recursive($this->modelName()))) {
            return $this->state([
