...
use Onepix\FoodSpotVendor\Illuminate\Contracts\Container\BindingResolutionException;
...
use Onepix\FoodSpotVendor\Illuminate\Support\Facades\Gate;
...
class ModelInspector
{
     ...
     *
     * @var \Onepix\FoodSpotVendor\Illuminate\Contracts\Foundation\Application
     */
    protected $app;
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Foundation\Application  $app
     * @return void
     */
     ...
     *
     * @param  class-string<\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model>|string  $model
     * @param  string|null  $connection
     * @return array{"class": class-string<\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model>, database: string, table: string, policy: class-string|null, attributes: \Onepix\FoodSpotVendor\Illuminate\Support\Collection, relations: \Onepix\FoodSpotVendor\Illuminate\Support\Collection, events: \Onepix\FoodSpotVendor\Illuminate\Support\Collection, observers: \Onepix\FoodSpotVendor\Illuminate\Support\Collection, collection: class-string<\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Collection<\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model>>, builder: class-string<\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model>>}
     *
    ...
    public function inspect($model, $connection = null)
    {
        ...
        /** @var \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model $model */
     ...
     * @return \Onepix\FoodSpotVendor\Illuminate\Support\Collection<int, array<string, mixed>>
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model  $model
     * @return class-string<\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Collection>
     */
     ...
     *
     * @param  TModel  $model
     * @return class-string<\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<TModel>>
     */
     ...
     *
     * @param  string  $model
     * @return class-string<\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model>
     *
