...
use Closure;
use Exception;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Eloquent\Builder as BuilderContract;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression;
...
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Concerns\QueriesRelationships;
...
use Onepix\FoodSpotVendor\Illuminate\Database\Query\Builder as QueryBuilder;
use Onepix\FoodSpotVendor\Illuminate\Database\RecordsNotFoundException;
use Onepix\FoodSpotVendor\Illuminate\Database\UniqueConstraintViolationException;
 ...
 *
 * @mixin \Onepix\FoodSpotVendor\Illuminate\Database\Query\Builder
 */
class Builder implements BuilderContract
{
    /** @use \Onepix\FoodSpotVendor\Illuminate\Database\Concerns\BuildsQueries<TModel> */
     ...
     *
     * @var \Onepix\FoodSpotVendor\Illuminate\Database\Query\Builder
     */
    protected $query;
     ...
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  (\Closure(static): mixed)|string|array|\Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  (\Closure(static): mixed)|array|string|\Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  array  $items
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Collection<int, TModel>
     */
     ...
     * @return ($id is (\Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Collection<int, TModel> : TModel|null)
     */
     ...
     * @return TModel
     *
     * @throws \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\ModelNotFoundException<TModel>
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable|array  $ids
     * @param  array|string  $columns
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Collection<int, TModel>
     */
     ...
     * @param  mixed  $id
     * @param  array|string  $columns
     * @return ($id is (\Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Collection<int, TModel> : TModel)
     *
     * @throws \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\ModelNotFoundException<TModel>
     */
     ...
     * @return (
     *     $id is (\Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>)
     *     ? \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Collection<int, TModel>
     *     : TModel|TValue
     * )
     */
    ...
    {
        return onepix_foodspotvendor_tap($this->firstOrCreate($attributes, $values), function ($instance) use ($values) {
    ...
    {
        return onepix_foodspotvendor_tap($this->firstOrCreate($attributes, [$column => $default]), function ($instance) use ($column, $step, $extra) {
            if (! $instance->wasRecentlyCreated) {
     ...
     *
     * @param  string  $name
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\Relation<\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model, TModel, *>
     */
     ...
     *
     * @return \Onepix\FoodSpotVendor\Illuminate\Support\LazyCollection<int, TModel>
     */
    ...
    public function paginate($perPage = null, $columns = ['*'], $pageName = 'page', $page = null, $total = null)
    {
        ...
        $total = onepix_foodspotvendor_value($total) ?? $this->toBase()->getCountForPagination();

        $perPage = onepix_foodspotvendor_value($perPage, $total) ?: $this->model->getPerPage();
    ...
    {
        return onepix_foodspotvendor_tap($this->newModelInstance($attributes), function ($instance) {
            $instance->save();
        });
    }
     ...
     *
     * @param  array<array-key, array|(\Closure(\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\Relation<*,*,*>): mixed)|string>|string  $relations
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression|array|string  $attributes
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  array|\Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression  $columns
     * @return array
     */
