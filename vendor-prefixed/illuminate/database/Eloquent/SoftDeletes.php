...
/**
 * @method static \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<static> withTrashed(bool $withTrashed = true)
 * @method static \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<static> onlyTrashed()
 * @method static \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<static> withoutTrashed()
...
trait SoftDeletes
{
    ...
    public function forceDelete()
    {
        ...
        return onepix_foodspotvendor_tap($this->delete(), function ($deleted) {
    ...
    protected function performDeleteOnModel()
    {
        if ($this->forceDeleting) {
            return onepix_foodspotvendor_tap($this->setKeysForSaveQuery($this->newModelQuery())->forceDelete(), function () {
                $this->exists = false;
            });
        }
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Events\QueuedClosure|callable|class-string  $callback
     * @return void
     */
