...
use ArrayAccess;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Broadcasting\HasBroadcastChannel;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Queue\QueueableCollection;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Queue\QueueableEntity;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Routing\UrlRoutable;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Support\CanBeEscapedWhenCastToString;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Jsonable;
use Onepix\FoodSpotVendor\Illuminate\Database\ConnectionResolverInterface as Resolver;
...
use Onepix\FoodSpotVendor\Illuminate\Support\Collection as BaseCollection;
...
{
    use \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Concerns\HasAttributes, \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Concerns\HasEvents, \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Concerns\HasGlobalScopes, \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Concerns\HasRelationships, \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Concerns\HasTimestamps, \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Concerns\HasUniqueIds, \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Concerns\HidesAttributes, \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Concerns\GuardsAttributes, \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Concerns\PreventsCircularRecursion, ForwardsCalls;
    /** @use HasCollection<\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Collection<array-key, static & self>> */
    use HasCollection;
    /**
     ...
     *
     * @var \Onepix\FoodSpotVendor\Illuminate\Contracts\Events\Dispatcher|null
     */
     ...
     *
     * @var class-string<\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<*>>
     */
    protected static string $builder = Builder::class;
    /**
     * The Eloquent collection class to use for the model.
     *
     * @var class-string<\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Collection<*, *>>
     */
    ...
    protected static function bootTraits()
    {
        ...
        foreach (onepix_foodspotvendor_class_uses_recursive($class) as $trait) {
            ...
            if (method_exists($class, $method = 'initialize' . onepix_foodspotvendor_class_basename($trait))) {
     ...
     * @return $this
     *
     * @throws \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\MassAssignmentException
     */
     ...
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Collection<int, static>
     */
    ...
    protected function incrementOrDecrement($column, $amount, $extra, $method)
    {
        ...
        return onepix_foodspotvendor_tap($this->setKeysForSaveQuery($this->newQueryWithoutScopes())->{$method}($column, $amount, $extra), function () use ($column) {
            $this->syncChanges();
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<static>  $query
     * @return bool
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Support\Collection|array|int|string  $ids
     * @return int
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<static>  $builder
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<static>
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Scope|string  $scope
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<static>
     */
     ...
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<*>
     */
     ...
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\Pivot
     */
     ...
     * @return string
     *
     * @throws \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\JsonEncodingException
     */
    ...
    public function refresh()
    {
        ...
        $this->load((new BaseCollection($this->relations))->reject(fn($relation) => $relation instanceof Pivot || is_object($relation) && in_array(AsPivot::class, onepix_foodspotvendor_class_uses_recursive($relation), true))->keys()->all());
        $this->syncOriginal();
        return $this;
    }
    /**
    ...
    public function replicate(?array $except = null)
    {
        ...
        return onepix_foodspotvendor_tap(new static(), function ($instance) use ($attributes) {
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model|null  $model
     * @return bool
     */
     ...
     *
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\ConnectionResolverInterface|null
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\ConnectionResolverInterface  $resolver
     * @return void
     */
     ...
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model|null
     */
     ...
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\Relation<\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model, $this, *>
     */
     ...
     * Retrieve the model for a bound value.
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model|\Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Eloquent\Builder|\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\Relation  $query
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Eloquent\Builder
     */
    ...
    {
        return $this->escapeWhenCastingToString ? onepix_foodspotvendor_e($this->toJson()) : $this->toJson();
    }
    /**
