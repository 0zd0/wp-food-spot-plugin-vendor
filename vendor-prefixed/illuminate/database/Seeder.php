...
use Onepix\FoodSpotVendor\Illuminate\Database\Console\Seeds\WithoutModelEvents;
    ...
    public function call($class, $silent = false, array $parameters = [])
    {
        ...
        foreach ($classes as $class) {
            ...
            if ($silent === false && isset($this->command)) {
                onepix_foodspotvendor_with(new TwoColumnDetail($this->command->getOutput()))->render(
                    $name,
