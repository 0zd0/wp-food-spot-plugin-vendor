...
use Onepix\FoodSpotVendor\Illuminate\Database\RecordNotFoundException;
...
trait BuildsQueries
{
     ...
     *
     * @param  int  $count
     * @param  callable(\Onepix\FoodSpotVendor\Illuminate\Support\Collection<int, TValue>, int): mixed  $callback
     * @return bool
     */
     ...
     * @param  int  $count
     * @return \Onepix\FoodSpotVendor\Illuminate\Support\Collection<int, TReturn>
     */
    ...
    public function orderedChunkById($count, callable $callback, $column = null, $alias = null, $descending = false)
    {
        ...
        do {
            ...
            $lastId = onepix_foodspotvendor_data_get($results->last(), $alias);
     ...
     *
     * @param  int  $chunkSize
     * @return \Onepix\FoodSpotVendor\Illuminate\Support\LazyCollection<int, TValue>
     *
     ...
     * @param  string|null  $alias
     * @param  bool  $descending
     * @return \Onepix\FoodSpotVendor\Illuminate\Support\LazyCollection
     *
     * @throws \InvalidArgumentException
     */
     ...
     * @return TValue
     *
     * @throws \Onepix\FoodSpotVendor\Illuminate\Database\RecordNotFoundException
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Query\Builder|\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<*>  $builder
