...
class DatabaseTransactionRecord
{
     ...
     *
     * @var \Onepix\FoodSpotVendor\Illuminate\Database\DatabaseTransactionRecord
     */
    public $parent;
     ...
     * @param  int  $level
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\DatabaseTransactionRecord|null  $parent
     * @return void
     */
