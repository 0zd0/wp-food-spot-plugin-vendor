...
namespace Onepix\FoodSpotVendor\Illuminate\Database\Migrations;
...
use Onepix\FoodSpotVendor\Illuminate\Database\Events\MigrationEnded;
use Onepix\FoodSpotVendor\Illuminate\Database\Events\MigrationsEnded;
use Onepix\FoodSpotVendor\Illuminate\Database\Events\MigrationsStarted;
use Onepix\FoodSpotVendor\Illuminate\Database\Events\MigrationStarted;
use Onepix\FoodSpotVendor\Illuminate\Database\Events\NoPendingMigrations;
...
class Migrator
{
     ...
     *
     * @var array<string, \Onepix\FoodSpotVendor\Illuminate\Database\Migrations\Migration|null>
     */
     ...
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Events\Dispatcher|null  $dispatcher
     * @return void
     */
    ...
    public function rollback($paths = [], array $options = [])
    {
        ...
        return onepix_foodspotvendor_tap($this->rollbackMigrations($migrations, $paths, $options), function () {
            $this->output?->writeln('');
        });
    }
    ...
    public function reset($paths = [], $pretend = false)
    {
        ...
        return onepix_foodspotvendor_tap($this->resetMigrations($migrations, Arr::wrap($paths), $pretend), function () {
            $this->output?->writeln('');
        });
    }
    ...
    public function usingConnection($name, callable $callback)
    {
        ...
        return onepix_foodspotvendor_tap($callback(), fn () => $this->setConnection($previousConnection));
    }
     ...
     *
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Symfony\Component\Console\Output\OutputInterface  $output
     * @return $this
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Events\MigrationEvent  $event
     * @return void
     */
