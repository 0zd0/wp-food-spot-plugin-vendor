...
abstract class Grammar
{
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression|string  $value
     * @return string
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression|string|int|float  $expression
