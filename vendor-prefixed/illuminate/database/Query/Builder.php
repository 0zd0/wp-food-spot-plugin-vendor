...
use Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Builder as BuilderContract;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\ConditionExpression;
...
use Onepix\FoodSpotVendor\Illuminate\Database\Concerns\BuildsQueries;
use Onepix\FoodSpotVendor\Illuminate\Database\Concerns\BuildsWhereDateClauses;
use Onepix\FoodSpotVendor\Illuminate\Database\Concerns\ExplainsQueries;
use Onepix\FoodSpotVendor\Illuminate\Database\ConnectionInterface;
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder as EloquentBuilder;
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Relations\Relation;
use Onepix\FoodSpotVendor\Illuminate\Database\Query\Grammars\Grammar;
...
use Onepix\FoodSpotVendor\Illuminate\Support\LazyCollection;
use Onepix\FoodSpotVendor\Illuminate\Support\Str;
use Onepix\FoodSpotVendor\Illuminate\Support\Traits\ForwardsCalls;
use Onepix\FoodSpotVendor\Illuminate\Support\Traits\Macroable;
use InvalidArgumentException;
use LogicException;
use RuntimeException;
use UnitEnum;

use function Onepix\FoodSpotVendor\Illuminate\Support\enum_value;

class Builder implements BuilderContract
{
    /** @use \Onepix\FoodSpotVendor\Illuminate\Database\Concerns\BuildsQueries<object> */
     ...
     *
     * @var \Onepix\FoodSpotVendor\Illuminate\Database\Query\Expression|string
     */
    public $from;
     ...
     *
     * @var \Onepix\FoodSpotVendor\Illuminate\Database\Query\IndexHint|null
     */
    public $indexHint;
     ...
     *
     * @param  \Closure|\Onepix\FoodSpotVendor\Illuminate\Database\Query\Builder|\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<*>|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Closure|\Onepix\FoodSpotVendor\Illuminate\Database\Query\Builder|\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<*>|\Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression|string  $table
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression|string  $table
     ...
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression|string  $second
     * @param  string  $type
     * @return $this
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression|string  $table
     * @param  \Closure|\Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression|string|null  $first
     * @param  string|null  $operator
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression|string|null  $second
     * @return $this
     */
     ...
     * @param  string  $type
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression|string  $table
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Query\JoinLateralClause
     */
     ...
     *
     * @param  \Closure|string|array|\Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression|string|array  $first
     * @param  string|null  $operator
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression|string  $column
     * @param  string  $value
     ...
     *
     * @param  string  $column
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression  $columns
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression  $column
     * @return $this
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Query\Builder  $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression|string  $column
     * @param  string  $operator
     * @param  \Closure|\Onepix\FoodSpotVendor\Illuminate\Database\Query\Builder|\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<*>  $callback
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[]  $columns
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  array|\Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression|string  ...$groups
     * @return $this
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression|\Closure|string  $column
     ...
     *
     * @param  \Closure|\Onepix\FoodSpotVendor\Illuminate\Database\Query\Builder|\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<*>|\Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\Onepix\FoodSpotVendor\Illuminate\Database\Query\Builder|\Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression|string  $column
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Onepix\FoodSpotVendor\Illuminate\Database\Query\Builder|\Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Onepix\FoodSpotVendor\Illuminate\Database\Query\Builder|\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Builder<*>  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     * @return mixed
     *
     * @throws \Onepix\FoodSpotVendor\Illuminate\Database\RecordsNotFoundException
     * @throws \Onepix\FoodSpotVendor\Illuminate\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @param  array|string  $columns
     * @return \Onepix\FoodSpotVendor\Illuminate\Support\Collection<int, \stdClass>
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Support\Collection  $items
    ...
    protected function withoutGroupLimitKeys($items)
    {
        ...
        if (is_string($this->groupLimit['column'])) {
            $column = onepix_foodspotvendor_last(explode('.', $this->groupLimit['column']));
    ...
    public function paginate($perPage = 15, $columns = ['*'], $pageName = 'page', $page = null, $total = null)
    {
        ...
        $total = onepix_foodspotvendor_value($total) ?? $this->getCountForPagination();

        $perPage = onepix_foodspotvendor_value($perPage, $total);
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \Onepix\FoodSpotVendor\Illuminate\Contracts\Pagination\Paginator
     */
     ...
     * @return \Onepix\FoodSpotVendor\Illuminate\Contracts\Pagination\CursorPaginator
     */
     ...
     *
     * @return \Onepix\FoodSpotVendor\Illuminate\Support\LazyCollection<int, \stdClass>
     */
     ...
     * @return \Onepix\FoodSpotVendor\Illuminate\Support\Collection<array-key, mixed>
     */
    ...
    protected function stripTableForPluck($column)
    {
        ...
        return onepix_foodspotvendor_last(preg_split('~'.$separator.'~i', $columnString));
    }
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression|string  $columns
     * @return int
     */
     ...
     *
     * @param  mixed  $value
     * @return \Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression
     */
    ...
    {
        return is_array($value) ? onepix_foodspotvendor_head(Arr::flatten($value)) : $value;
    }
     ...
     *
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\ConnectionInterface
     */
     ...
     *
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Query\Grammars\Grammar
     */
    ...
    {
        return onepix_foodspotvendor_tap($this->clone(), function ($clone) use ($properties) {
    ...
    {
        return onepix_foodspotvendor_tap($this->clone(), function ($clone) use ($except) {
