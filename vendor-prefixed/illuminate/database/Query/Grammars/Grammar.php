...
namespace Onepix\FoodSpotVendor\Illuminate\Database\Query\Grammars;

use Onepix\FoodSpotVendor\Illuminate\Contracts\Database\Query\Expression;
use Onepix\FoodSpotVendor\Illuminate\Database\Concerns\CompilesJsonPaths;
use Onepix\FoodSpotVendor\Illuminate\Database\Grammar as BaseGrammar;
...
use Onepix\FoodSpotVendor\Illuminate\Database\Query\JoinLateralClause;
...
class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Query\JoinLateralClause  $join
    ...
    public function prepareBindingsForUpdate(array $bindings, array $values)
    {
        ...
        $values = Arr::flatten(array_map(fn ($value) => onepix_foodspotvendor_value($value), $values));
    ...
    {
        $alias = onepix_foodspotvendor_last(explode(' as ', $table));
