...
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Concerns\HasUlids;
use Onepix\FoodSpotVendor\Illuminate\Database\Query\Expression;
use Onepix\FoodSpotVendor\Illuminate\Database\Schema\Grammars\Grammar;
use Onepix\FoodSpotVendor\Illuminate\Database\Schema\Grammars\MySqlGrammar;
use Onepix\FoodSpotVendor\Illuminate\Database\Schema\Grammars\SQLiteGrammar;
...
class Blueprint
{
     ...
     *
     * @var \Onepix\FoodSpotVendor\Illuminate\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @var \Onepix\FoodSpotVendor\Illuminate\Support\Fluent[]
     */
    protected $commands = [];
     ...
     *
     * @var \Onepix\FoodSpotVendor\Illuminate\Database\Schema\BlueprintState|null
     */
    protected $state;
     ...
     * Indicate that the given foreign key should be dropped.
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model|string  $model
     ...
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Schema\IndexDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Schema\ForeignIdColumnDefinition
     */
    ...
    public function foreignIdFor($model, $column = null)
    {
        ...
        $modelTraits = onepix_foodspotvendor_class_uses_recursive($model);
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Schema\ColumnDefinition  $definition
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Schema\BlueprintState
     */
