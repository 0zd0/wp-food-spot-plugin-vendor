...
namespace Onepix\FoodSpotVendor\Illuminate\Database\Console\Factories;
...
class FactoryMakeCommand extends GeneratorCommand
{
    ...
    {
        $factory = onepix_foodspotvendor_class_basename(Str::ucfirst(str_replace('Factory', '', $name)));

        $namespaceModel = $this->option('model')
                        ? $this->qualifyModel($this->option('model'))
                        : $this->qualifyModel($this->guessModelName($name));

        $model = onepix_foodspotvendor_class_basename($namespaceModel);
