...
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\ModelInspector;
...
class ShowModelCommand extends DatabaseInspectionCommand
{
     ...
     *
     * @param  class-string<\Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Model>  $class
     * @param  string  $database
     * @param  string  $table
     * @param  class-string|null  $policy
     * @param  \Onepix\FoodSpotVendor\Illuminate\Support\Collection  $attributes
     * @param  \Onepix\FoodSpotVendor\Illuminate\Support\Collection  $relations
     * @param  \Onepix\FoodSpotVendor\Illuminate\Support\Collection  $events
     * @param  \Onepix\FoodSpotVendor\Illuminate\Support\Collection  $observers
     * @return void
     */
