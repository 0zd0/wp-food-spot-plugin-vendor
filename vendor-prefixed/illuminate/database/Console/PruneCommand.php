...
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\MassPrunable;
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\Prunable;
use Onepix\FoodSpotVendor\Illuminate\Database\Eloquent\SoftDeletes;
use Onepix\FoodSpotVendor\Illuminate\Database\Events\ModelPruningFinished;
use Onepix\FoodSpotVendor\Illuminate\Database\Events\ModelPruningStarting;
...
class PruneCommand extends Command
{
    ...
    {
        $uses = onepix_foodspotvendor_class_uses_recursive($model);
    ...
    protected function pretendToPrune($model)
    {
        ...
        $count = $instance->prunable()
            ->when(in_array(SoftDeletes::class, onepix_foodspotvendor_class_uses_recursive(get_class($instance))), function ($query) {
                $query->withTrashed();
            })->count();
