...
use Onepix\FoodSpotVendor\Illuminate\Contracts\Console\Isolatable;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Events\Dispatcher;
use Onepix\FoodSpotVendor\Illuminate\Database\Events\SchemaLoaded;
use Onepix\FoodSpotVendor\Illuminate\Database\Migrations\Migrator;
use Onepix\FoodSpotVendor\Illuminate\Database\SQLiteDatabaseDoesNotExistException;
use Onepix\FoodSpotVendor\Illuminate\Database\SqlServerConnection;
...
class MigrateCommand extends BaseCommand implements Isolatable
{
     ...
     *
     * @var \Onepix\FoodSpotVendor\Illuminate\Database\Migrations\Migrator
     */
    protected $migrator;
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Database\Migrations\Migrator  $migrator
    ...
    {
        return onepix_foodspotvendor_retry(2, fn () => $this->migrator->repositoryExists(), 0, function ($e) {
            try {
    ...
    protected function createMissingMySqlOrPgsqlDatabase($connection)
    {
        ...
        try {
            ...
            return onepix_foodspotvendor_tap($freshConnection->unprepared(
                match ($connection->getDriverName()) {
