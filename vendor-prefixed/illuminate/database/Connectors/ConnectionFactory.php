...
namespace Onepix\FoodSpotVendor\Illuminate\Database\Connectors;
...
use Onepix\FoodSpotVendor\Illuminate\Database\MariaDbConnection;
use Onepix\FoodSpotVendor\Illuminate\Database\MySqlConnection;
use Onepix\FoodSpotVendor\Illuminate\Database\PostgresConnection;
use Onepix\FoodSpotVendor\Illuminate\Database\SQLiteConnection;
...
class ConnectionFactory
{
     ...
     *
     * @param  array  $config
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\Connectors\ConnectorInterface
     *
     * @throws \InvalidArgumentException
     */
