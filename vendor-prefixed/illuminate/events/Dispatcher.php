...
use Onepix\FoodSpotVendor\Illuminate\Contracts\Broadcasting\Factory as BroadcastFactory;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Broadcasting\ShouldBroadcast;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Container\Container as ContainerContract;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Events\Dispatcher as DispatcherContract;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Events\ShouldDispatchAfterCommit;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Events\ShouldHandleEventsAfterCommit;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Queue\ShouldBeEncrypted;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Queue\ShouldQueue;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Queue\ShouldQueueAfterCommit;
...
use Onepix\FoodSpotVendor\Illuminate\Support\Traits\ReflectsClosures;
use ReflectionClass;
...
class Dispatcher implements DispatcherContract
{
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Container\Container|null  $container
     * @return void
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Events\QueuedClosure|callable|array|class-string|string  $events
     * @param  \Onepix\FoodSpotVendor\Illuminate\Events\QueuedClosure|callable|array|class-string|null  $listener
     * @return void
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Broadcasting\ShouldBroadcast  $event
     * @return void
     */
     ...
     *
     * @param  mixed  $listener
     * @param  \Onepix\FoodSpotVendor\Illuminate\Events\CallQueuedListener  $job
     * @return mixed
     */
    protected function propagateListenerOptions($listener, $job)
    {
        return onepix_foodspotvendor_tap($job, function ($job) use ($listener) {
     ...
     *
     * @return \Onepix\FoodSpotVendor\Illuminate\Database\DatabaseTransactionsManager|null
     */
