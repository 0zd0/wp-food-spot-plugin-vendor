...
use Onepix\FoodSpotVendor\Illuminate\Bus\Queueable;
use Onepix\FoodSpotVendor\Illuminate\Container\Container;
use Onepix\FoodSpotVendor\Illuminate\Contracts\Queue\Job;
...
class CallQueuedListener implements ShouldQueue
{
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Container\Container  $container
     * @return void
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Queue\Job  $job
     * @param  object  $instance
     * @return object
     */
    protected function setJobInstanceIfNecessary(Job $job, $instance)
    {
        if (in_array(InteractsWithQueue::class, onepix_foodspotvendor_class_uses_recursive($instance))) {
            $instance->setJob($job);
        }
