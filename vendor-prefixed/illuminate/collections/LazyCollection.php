...
use Onepix\FoodSpotVendor\Illuminate\Support\Traits\EnumeratesValues;
 ...
 *
 * @implements \Onepix\FoodSpotVendor\Illuminate\Support\Enumerable<TKey, TValue>
 */
class LazyCollection implements CanBeEscapedWhenCastToString, Enumerable
{
    /**
     * @use \Onepix\FoodSpotVendor\Illuminate\Support\Traits\EnumeratesValues<TKey, TValue>
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable<TKey, TValue>|iterable<TKey, TValue>|(Closure(): \Generator<TKey, TValue, mixed, void>)|self<TKey, TValue>|array<TKey, TValue>|null  $source
     * @return void
     */
     ...
     * @template TMakeValue
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable<TMakeKey, TMakeValue>|iterable<TMakeKey, TMakeValue>|(Closure(): \Generator<TMakeKey, TMakeValue, mixed, void>)|self<TMakeKey, TMakeValue>|array<TMakeKey, TMakeValue>|null  $items
    ...
    {
        if (func_num_args() === 2) {
            return $this->contains(fn ($item) => onepix_foodspotvendor_data_get($item, $key) === $value);
        }
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable<TCrossJoinKey, TCrossJoinValue>|iterable<TCrossJoinKey, TCrossJoinValue>  ...$arrays
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable<array-key, TValue>|iterable<array-key, TValue>  $items
     * @return static
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable<TKey, TValue>|iterable<TKey, TValue>  $items
     * @return static
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable<TKey, mixed>|iterable<TKey, mixed>  $items
     * @return static
     */
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Support\Enumerable<array-key, TKey>|array<array-key, TKey>  $keys
     * @return static
     */
    ...
    public function last(?callable $callback = null, $default = null)
    {
        ...
        return $needle === $placeholder ? onepix_foodspotvendor_value($default) : $needle;
    }
    ...
    public function pluck($value, $key = null)
    {
        return new static(function () use ($value, $key) {
            ...
            foreach ($this as $item) {
                $itemValue = onepix_foodspotvendor_data_get($item, $value);

                if (is_null($key)) {
                    yield $itemValue;
                } else {
                    $itemKey = onepix_foodspotvendor_data_get($item, $key);
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable<TKey, TMergeRecursiveValue>|iterable<TKey, TMergeRecursiveValue>  $items
     ...
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Support\Enumerable<array-key, TKey>|array<array-key, TKey>|string  $keys
     * @return static
     */
     ...
     * @return TValue
     *
     * @throws \Onepix\FoodSpotVendor\Illuminate\Support\ItemNotFoundException
     * @throws \Onepix\FoodSpotVendor\Illuminate\Support\MultipleItemsFoundException
     */
     ...
     * @template TZipValue
     *
     * @param  \Onepix\FoodSpotVendor\Illuminate\Contracts\Support\Arrayable<array-key, TZipValue>|iterable<array-key, TZipValue>  ...$items
