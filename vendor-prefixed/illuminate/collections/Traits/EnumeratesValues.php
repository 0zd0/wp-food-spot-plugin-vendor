...
use Onepix\FoodSpotVendor\Illuminate\Support\HigherOrderCollectionProxy;
...
trait EnumeratesValues
{
    ...
    {
        return $this->filter(
            fn ($item) => onepix_foodspotvendor_data_get($item, $key) < reset($values) || onepix_foodspotvendor_data_get($item, $key) > end($values)
        );
    }
        ...
        foreach ($this as $key => $value) {
            ...
            if (! is_array($result)) {
                throw new UnexpectedValueException(sprintf(
                    ...
                    onepix_foodspotvendor_class_basename(static::class), gettype($result)
                ));
            }
        }
    ...
    public function __toString()
    {
        return $this->escapeWhenCastingToString
                    ? onepix_foodspotvendor_e($this->toJson())
                    : $this->toJson();
    }
    ...
    protected function valueRetriever($value)
    {
        ...
        return fn ($item) => onepix_foodspotvendor_data_get($item, $value);
    }
