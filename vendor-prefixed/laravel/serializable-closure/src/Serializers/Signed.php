...
use Onepix\FoodSpotVendor\Laravel\SerializableClosure\Exceptions\MissingSecretKeyException;
...
class Signed implements Serializable
{
     ...
     *
     * @var \Onepix\FoodSpotVendor\Laravel\SerializableClosure\Contracts\Signer|null
     */
    ...
    public function __unserialize($signature)
    {
        ...
        /** @var \Onepix\FoodSpotVendor\Laravel\SerializableClosure\Contracts\Serializable $serializable */
