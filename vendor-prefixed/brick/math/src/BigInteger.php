...
namespace Onepix\FoodSpotVendor\Brick\Math;

use Onepix\FoodSpotVendor\Brick\Math\Exception\DivisionByZeroException;
use Onepix\FoodSpotVendor\Brick\Math\Exception\IntegerOverflowException;
use Onepix\FoodSpotVendor\Brick\Math\Exception\MathException;
use Onepix\FoodSpotVendor\Brick\Math\Exception\NegativeNumberException;
use Onepix\FoodSpotVendor\Brick\Math\Exception\NumberFormatException;
