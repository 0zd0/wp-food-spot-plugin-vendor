...
use Onepix\FoodSpotVendor\Symfony\Component\Cache\Traits\FilesystemCommonTrait;
use Onepix\FoodSpotVendor\Symfony\Component\VarExporter\VarExporter;
    ...
    protected function doSave(array $values, int $lifetime): array|bool
    {
        ...
        foreach ($values as $key => $value) {
            ...
            if ($isStaticValue) {
                ...
                $value = str_replace('\Onepix\FoodSpotVendor\Symfony\Component\VarExporter\Internal\\', '', $value);
