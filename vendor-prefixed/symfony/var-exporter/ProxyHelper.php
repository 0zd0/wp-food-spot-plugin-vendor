...
use Onepix\FoodSpotVendor\Symfony\Component\VarExporter\Exception\LogicException;
use Onepix\FoodSpotVendor\Symfony\Component\VarExporter\Internal\Hydrator;
use Onepix\FoodSpotVendor\Symfony\Component\VarExporter\Internal\LazyDecoratorTrait;
use Onepix\FoodSpotVendor\Symfony\Component\VarExporter\Internal\LazyObjectRegistry;
...
final class ProxyHelper
{
    ...
    public static function generateLazyGhost(\ReflectionClass $class): string
    {
        if (\PHP_VERSION_ID >= 80400) {
            onepix_foodspotvendor_trigger_deprecation('symfony/var-exporter', '7.3', 'Using ProxyHelper::generateLazyGhost() is deprecated, use native lazy objects instead.');
        }
        ...
        return <<<EOPHP
             extends \\{$class->name} implements \Onepix\FoodSpotVendor\Symfony\Component\VarExporter\LazyObjectInterface
            {
                use \Onepix\FoodSpotVendor\Symfony\Component\VarExporter\LazyGhostTrait;

                private const LAZY_OBJECT_PROPERTY_SCOPES = {$propertyScopes};
            {$hooks}}

            // Help opcache.preload discover always-needed symbols
            class_exists(\Onepix\FoodSpotVendor\Symfony\Component\VarExporter\Internal\Hydrator::class);
            class_exists(\Onepix\FoodSpotVendor\Symfony\Component\VarExporter\Internal\LazyObjectRegistry::class);
            class_exists(\Onepix\FoodSpotVendor\Symfony\Component\VarExporter\Internal\LazyObjectState::class);
    ...
    public static function generateLazyProxy(?\ReflectionClass $class, array $interfaces = []): string
    {
        ...
        if ($class && !$class->isAbstract()) {
            ...
            if (!$extendsInternalClass) {
                onepix_foodspotvendor_trigger_deprecation('symfony/var-exporter', '7.3', 'Generating lazy proxy for class "%s" is deprecated; leverage native lazy objects instead.', $class->name);
    ...
    private static function generateLegacyLazyProxy(?\ReflectionClass $class, array $interfaces): string
    {
        ...
        if (
            ...
            // fix contravariance type problem when $class declares a `__unserialize()` method without typehint.
            $lazyProxyTraitStatement = <<<EOPHP
            use \Onepix\FoodSpotVendor\Symfony\Component\VarExporter\LazyProxyTrait {
