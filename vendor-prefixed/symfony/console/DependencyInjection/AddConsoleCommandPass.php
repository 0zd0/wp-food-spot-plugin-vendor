...
namespace Onepix\FoodSpotVendor\Symfony\Component\Console\DependencyInjection;
...
use Onepix\FoodSpotVendor\Symfony\Component\Console\CommandLoader\ContainerCommandLoader;
    ...
    public function process(ContainerBuilder $container): void
    {
        ...
        foreach ($commandServices as $id => $tags) {
            ...
            if (Command::class !== (new \ReflectionMethod($class, 'getDefaultName'))->class) {
                onepix_foodspotvendor_trigger_deprecation('symfony/console', '7.3', 'Overriding "Command::getDefaultName()" in "%s" is deprecated and will be removed in Symfony 8.0, use the #[AsCommand] attribute instead.', $class);
            ...
            if (!$description) {
                if (Command::class !== (new \ReflectionMethod($class, 'getDefaultDescription'))->class) {
                    onepix_foodspotvendor_trigger_deprecation('symfony/console', '7.3', 'Overriding "Command::getDefaultDescription()" in "%s" is deprecated and will be removed in Symfony 8.0, use the #[AsCommand] attribute instead.', $class);
