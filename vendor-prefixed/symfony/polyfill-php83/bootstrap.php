...
use Onepix\FoodSpotVendor\Symfony\Polyfill\Php83 as p;
...
if (!function_exists('onepix_foodspotvendor_ldap_connect_wallet') && function_exists('ldap_connect')) {
    function onepix_foodspotvendor_ldap_connect_wallet(?string $uri, string $wallet, string $password, int $auth_mode = \GSLC_SSL_NO_AUTH) { return ldap_connect($uri, $wallet, $password, $auth_mode); }
}
