...
namespace Onepix\FoodSpotVendor\Carbon_Fields\REST_API;
...
class Decorator {
			...
			foreach ( $fields as $field ) {
				...
				$getter = function( $object, $field_name ) use ( $container ) {
					...
					if ( apply_filters( 'carbon_fields_rest_api_return_attachments_as_urls', false, $value, $field, $object_id ) ) {
                        $attachments_class = [
                            "Onepix\FoodSpotVendor\Carbon_Fields\Field\Media_Gallery_Field",
                            "Onepix\FoodSpotVendor\Carbon_Fields\Field\File_Field",
                            "Onepix\FoodSpotVendor\Carbon_Fields\Field\Image_Field"
                        ];
	 ...
	 *
	 * @param \Onepix\FoodSpotVendor\Carbon_Fields\Container\Post_Meta_Container $container
	 * @return array
	 */
	 ...
	 *
	 * @param \Onepix\FoodSpotVendor\Carbon_Fields\Container\Term_Meta_Container $container
	 * @return array
	 */
	 ...
	 *
	 * @param \Onepix\FoodSpotVendor\Carbon_Fields\Container\User_Meta_Container $container
	 * @return string
	 */
	 ...
	 *
	 * @param \Onepix\FoodSpotVendor\Carbon_Fields\Container\Comment_Meta_Container $container
	 * @return string
	 */
