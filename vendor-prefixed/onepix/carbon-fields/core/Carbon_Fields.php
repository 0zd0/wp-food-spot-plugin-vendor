...
use Onepix\FoodSpotVendor\Carbon_Fields\Loader\Loader;
use Onepix\FoodSpotVendor\Carbon_Fields\Container\Repository as ContainerRepository;
use Onepix\FoodSpotVendor\Carbon_Fields\Toolset\Key_Toolset;
use Onepix\FoodSpotVendor\Carbon_Fields\Toolset\WP_Toolset;
...
use Onepix\FoodSpotVendor\Carbon_Fields\Service\Revisions_Service;
...
use Onepix\FoodSpotVendor\Carbon_Fields\REST_API\Router as REST_API_Router;
use Onepix\FoodSpotVendor\Carbon_Fields\REST_API\Decorator as REST_API_Decorator;
use Onepix\FoodSpotVendor\Carbon_Fields\Event\Emitter;
use Onepix\FoodSpotVendor\Carbon_Fields\Event\PersistentListener;
use Onepix\FoodSpotVendor\Carbon_Fields\Event\SingleEventListener;
...
final class Carbon_Fields
{
    ...
    protected static function get_default_ioc()
    {
        ...
        $ioc->register(new \Onepix\FoodSpotVendor\Carbon_Fields\Provider\Container_Condition_Provider());
        return $ioc;
    }
}