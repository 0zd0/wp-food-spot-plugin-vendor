...
namespace Onepix\FoodSpotVendor\Carbon_Fields\Helper;

use Onepix\FoodSpotVendor\Carbon_Fields\Datastore\Datastore;
...
class Helper {
	...
	public static function get_field( $container_type, $container_id, $field_name ) {
		\Onepix\FoodSpotVendor\Carbon_Fields\Carbon_Fields::verify_fields_registered();

		$repository = \Onepix\FoodSpotVendor\Carbon_Fields\Carbon_Fields::resolve( 'container_repository' );
		if ( $container_id ) {
	...
	public static function get_value( $object_id, $container_type, $container_id, $field_name ) {
		return static::with_field_clone(
			...
			function( $field ) {
				...
				/** @var \Onepix\FoodSpotVendor\Carbon_Fields\Field\Field $field */
				$field->load();
	...
	public static function input() {
		...
		if ( \Onepix\FoodSpotVendor\Carbon_Fields\COMPACT_INPUT ) {
	...
	public static function expand_compacted_input( $input ) {
		if ( isset( $input[ \Onepix\FoodSpotVendor\Carbon_Fields\COMPACT_INPUT_KEY ] ) ) {
			$inputs = $input[ \Onepix\FoodSpotVendor\Carbon_Fields\COMPACT_INPUT_KEY ];
