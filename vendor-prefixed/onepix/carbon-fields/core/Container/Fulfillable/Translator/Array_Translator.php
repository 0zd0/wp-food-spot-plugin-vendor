...
namespace Onepix\FoodSpotVendor\Carbon_Fields\Container\Fulfillable\Translator;

use Onepix\FoodSpotVendor\Carbon_Fields\Container\Condition\Factory;
use Onepix\FoodSpotVendor\Carbon_Fields\Container\Fulfillable\Fulfillable_Collection;
use Onepix\FoodSpotVendor\Carbon_Fields\Container\Condition\Condition;
...
class Array_Translator extends Translator {
	...
	protected function foreign_to_native_fulfillable_collection( $foreign ) {
		...
		$collection = \Onepix\FoodSpotVendor\Carbon_Fields\Carbon_Fields::resolve( 'container_condition_fulfillable_collection' );
