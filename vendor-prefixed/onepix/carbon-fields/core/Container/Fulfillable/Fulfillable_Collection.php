...
namespace Onepix\FoodSpotVendor\Carbon_Fields\Container\Fulfillable;

use Onepix\FoodSpotVendor\Carbon_Fields\Container\Condition\Factory;
use Onepix\FoodSpotVendor\Carbon_Fields\Container\Fulfillable\Translator\Array_Translator;
...
class Fulfillable_Collection implements Fulfillable {
	...
	protected function create_collection() {
		return \Onepix\FoodSpotVendor\Carbon_Fields\Carbon_Fields::resolve( 'container_condition_fulfillable_collection' );
	}
