...
namespace Onepix\FoodSpotVendor\Carbon_Fields\Container;

use Onepix\FoodSpotVendor\Carbon_Fields\Carbon_Fields;
use Onepix\FoodSpotVendor\Carbon_Fields\Helper\Helper;
use Onepix\FoodSpotVendor\Carbon_Fields\Field\Field;
use Onepix\FoodSpotVendor\Carbon_Fields\Field\Group_Field;
use Onepix\FoodSpotVendor\Carbon_Fields\Container\Fulfillable\Fulfillable_Collection;
use Onepix\FoodSpotVendor\Carbon_Fields\Datastore\Datastore_Interface;
use Onepix\FoodSpotVendor\Carbon_Fields\Datastore\Datastore_Holder_Interface;
...
abstract class Container implements Datastore_Holder_Interface {
	 ...
	 *
	 * @var \Onepix\FoodSpotVendor\Carbon_Fields\Container\Fulfillable\Translator\Translator
	 */
	 ...
	 * @param \Onepix\FoodSpotVendor\Carbon_Fields\Container\Fulfillable\Translator\Translator $condition_translator
	 */
		...
		while ( ! empty( $hierarchy_left ) ) {
			...
			foreach ( $field_group as $f ) {
				...
				if ( empty( $hierarchy_left ) ) {
					...
					if ( ! ( $f instanceof \Onepix\FoodSpotVendor\Carbon_Fields\Field\Complex_Field ) ) {
						return null;
					}
