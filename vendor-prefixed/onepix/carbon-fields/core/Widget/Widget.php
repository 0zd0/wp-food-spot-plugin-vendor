...
namespace Onepix\FoodSpotVendor\Carbon_Fields\Widget;
...
abstract class Widget extends \WP_Widget {
	 ...
	 * Widget Datastore
	 *
	 * @var \Onepix\FoodSpotVendor\Carbon_Fields\Datastore\Widget_Datastore
	 */
	protected $datastore;
	...
	public function setup( $widget_id, $title, $description, $fields, $classname = '' ) {
		\Onepix\FoodSpotVendor\Carbon_Fields\Carbon_Fields::verify_boot();
	...
	public function add_fields( $fields ) {
		foreach ( $fields as $field ) {
			if ( ! ( $field instanceof \Onepix\FoodSpotVendor\Carbon_Fields\Field\Field ) ) {
