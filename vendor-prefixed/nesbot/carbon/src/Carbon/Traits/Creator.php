...
use Onepix\FoodSpotVendor\Carbon\Exceptions\InvalidDateException;
use Onepix\FoodSpotVendor\Carbon\Exceptions\InvalidFormatException;
use Onepix\FoodSpotVendor\Carbon\Exceptions\InvalidTimeZoneException;
use Onepix\FoodSpotVendor\Carbon\Exceptions\OutOfRangeException;
use Onepix\FoodSpotVendor\Carbon\Exceptions\UnitException;
use Onepix\FoodSpotVendor\Carbon\Month;
use Onepix\FoodSpotVendor\Carbon\Translator;
use Onepix\FoodSpotVendor\Carbon\WeekDay;
use Closure;
...
trait Creator
{
    ...
    public static function rawCreateFromFormat(string $format, string $time, $timezone = null): ?self
    {
        ...
        /** @var \Onepix\FoodSpotVendor\Carbon\CarbonImmutable|\Onepix\FoodSpotVendor\Carbon\Carbon|null $mock */
