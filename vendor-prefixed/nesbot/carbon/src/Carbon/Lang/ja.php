...
return [
    ...
    'calendar' => [
        'sameDay' => '[今日] LT',
        'nextDay' => '[明日] LT',
        'nextWeek' => static function (CarbonInterface $current, \Onepix\FoodSpotVendor\Carbon\CarbonInterface $other) {
        ...
        'lastDay' => '[昨日] LT',
        'lastWeek' => static function (CarbonInterface $current, \Onepix\FoodSpotVendor\Carbon\CarbonInterface $other) {
            if ($other->week !== $current->week) {
                return '[先週]dddd LT';
            }
