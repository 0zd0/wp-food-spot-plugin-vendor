...
use Onepix\FoodSpotVendor\Carbon\Exceptions\BadFluentConstructorException;
use Onepix\FoodSpotVendor\Carbon\Exceptions\BadFluentSetterException;
use Onepix\FoodSpotVendor\Carbon\Exceptions\InvalidCastException;
use Onepix\FoodSpotVendor\Carbon\Exceptions\InvalidFormatException;
use Onepix\FoodSpotVendor\Carbon\Exceptions\InvalidIntervalException;
use Onepix\FoodSpotVendor\Carbon\Exceptions\OutOfRangeException;
use Onepix\FoodSpotVendor\Carbon\Exceptions\ParseErrorException;
use Onepix\FoodSpotVendor\Carbon\Exceptions\UnitNotConfiguredException;
use Onepix\FoodSpotVendor\Carbon\Exceptions\UnknownGetterException;
use Onepix\FoodSpotVendor\Carbon\Exceptions\UnknownSetterException;
use Onepix\FoodSpotVendor\Carbon\Exceptions\UnknownUnitException;
use Onepix\FoodSpotVendor\Carbon\Traits\IntervalRounding;
use Onepix\FoodSpotVendor\Carbon\Traits\IntervalStep;
use Onepix\FoodSpotVendor\Carbon\Traits\LocalFactory;
use Onepix\FoodSpotVendor\Carbon\Traits\MagicParameter;
use Onepix\FoodSpotVendor\Carbon\Traits\Mixin;
use Onepix\FoodSpotVendor\Carbon\Traits\Options;
use Onepix\FoodSpotVendor\Carbon\Traits\ToStringFormat;
use Closure;
use DateInterval;
use DateTime;
...
class CarbonInterval extends DateInterval implements CarbonConverterInterface
{
     ...
     *
     * @throws \Onepix\FoodSpotVendor\Carbon\Exceptions\ParseErrorException when the $interval cannot be parsed as an interval.
     *
     * @return static
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Carbon\Carbon|\DateTimeInterface|mixed $start
     * @param \Onepix\FoodSpotVendor\Carbon\Carbon|\DateTimeInterface|mixed $end
     *
     * @return static
     */
