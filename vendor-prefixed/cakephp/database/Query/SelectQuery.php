 ...
 */
namespace Onepix\FoodSpotVendor\Cake\Database\Query;
...
use Onepix\FoodSpotVendor\Cake\Database\Expression\WindowExpression;
...
class SelectQuery extends Query implements IteratorAggregate
{
     ...
     *
     * @var \Onepix\FoodSpotVendor\Cake\Database\TypeMap|null
     */
     ...
     *
     * @return iterable
     * @throws \Onepix\FoodSpotVendor\Cake\Core\Exception\CakeException When query is not a SELECT query.
     */
     ...
     * from the table.
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|\Closure|array|string|float|int $fields fields to be added to the list.
     ...
     * ```
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|array|string|bool $on Enable/disable distinct class
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|array|string $fields fields to be added to the list
     * @param bool $overwrite whether to reset fields with passed list or not
     * @return $this
    ...
    {
        onepix_foodspotvendor_deprecationWarning('5.0.0', 'SelectQuery::group() is deprecated. Use SelectQuery::groupBy() instead.');
     ...
     * not sanitized by the query builder.
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|\Closure|array|string|null $conditions The having conditions.
     ...
     * not sanitized by the query builder.
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|\Closure|array|string $conditions The AND conditions for HAVING.
     * @param array<string, string> $types Associative array of type names used to bind values to query
     * @see \Onepix\FoodSpotVendor\Cake\Database\Query::andWhere()
     * @return $this
     */
     ...
     * @param \Onepix\FoodSpotVendor\Cake\Database\Expression\WindowExpression|\Closure $window Window expression
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query|string $query full SQL query to be used in UNION operator
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query|string $query full SQL query to be used in INTERSECT operator
     * @param bool $overwrite whether to reset the list of queries to be operated or not
     * @return $this
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\TypeMap|array $typeMap Creates a TypeMap if array, otherwise sets the given TypeMap.
     * @return $this
     */
     ...
     * select clause are stored.
     *
     * @return \Onepix\FoodSpotVendor\Cake\Database\TypeMap
     */
