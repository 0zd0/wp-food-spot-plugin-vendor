...
use Onepix\FoodSpotVendor\Cake\Database\Expression\ValuesExpression;
...
class InsertQuery extends Query
{
    ...
    public function insert(array $columns, array $types = [])
    {
        ...
        if (!$this->_parts['values']) {
            ...
            /** @var \Onepix\FoodSpotVendor\Cake\Database\Expression\ValuesExpression $valuesExpr */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Expression\ValuesExpression|\Onepix\FoodSpotVendor\Cake\Database\Query|array $data The data to insert.
     * @return $this
     * @throws \Onepix\FoodSpotVendor\Cake\Database\Exception\DatabaseException if you try to set values before declaring columns.
