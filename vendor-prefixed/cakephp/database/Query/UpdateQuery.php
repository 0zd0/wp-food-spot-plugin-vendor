...
class UpdateQuery extends Query
{
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|string $table The table you want to update.
     * @return $this
     */
     ...
     * ```
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Expression\QueryExpression|\Closure|array|string $key The column name or array of keys
    ...
    public function set(QueryExpression|Closure|array|string $key, mixed $value = null, array|string $types = [])
    {
        ...
        if ($key instanceof Closure) {
            ...
            /** @var \Onepix\FoodSpotVendor\Cake\Database\Expression\QueryExpression $setExpr */
