...
use Onepix\FoodSpotVendor\Cake\Database\Type\BatchCastingInterface;
use Onepix\FoodSpotVendor\Cake\Database\Type\OptionalConvertInterface;
...
class FieldTypeConverter
{
     ...
     * Builds the type map
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\TypeMap $typeMap Contains the types to use for converting results
     * @param \Onepix\FoodSpotVendor\Cake\Database\Driver $driver The driver to use for the type conversion
     */
    ...
    public function __invoke(mixed $row): mixed
    {
        ...
        foreach ($this->conversions as $conversion) {
            /** @var \Onepix\FoodSpotVendor\Cake\Database\TypeInterface $type */
            $type = $conversion['type'];
            if ($conversion['hasBatch']) {
                /** @var \Onepix\FoodSpotVendor\Cake\Database\Type\BatchCastingInterface $type */
