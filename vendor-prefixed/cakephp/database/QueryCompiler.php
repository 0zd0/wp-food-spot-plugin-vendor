...
class QueryCompiler
{
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query $query The query that is being compiled
     * @param \Onepix\FoodSpotVendor\Cake\Database\ValueBinder $binder Value binder used to generate parameter placeholders
     * @return string
     */
     ...
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query $query The query that is being compiled
     * @param \Onepix\FoodSpotVendor\Cake\Database\ValueBinder $binder Value binder used to generate parameter placeholder
     * @return \Closure
     */
     ...
     *
     * @param array<\Onepix\FoodSpotVendor\Cake\Database\Expression\CommonTableExpression> $parts List of CTEs to be transformed to string
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query $query The query that is being compiled
     * @param \Onepix\FoodSpotVendor\Cake\Database\ValueBinder $binder Value binder used to generate parameter placeholder
     * @return string
     */
    ...
    protected function _buildWindowPart(array $parts, Query $query, ValueBinder $binder): string
    {
        ...
        foreach ($parts as $window) {
            /** @var \Onepix\FoodSpotVendor\Cake\Database\Expression\IdentifierExpression $expr */
            $expr = $window['name'];
            /** @var \Onepix\FoodSpotVendor\Cake\Database\Expression\IdentifierExpression $windowExpr */
     ...
     * @param array $parts
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query $query
     * @param \Onepix\FoodSpotVendor\Cake\Database\ValueBinder $binder
     * @return string
     */
