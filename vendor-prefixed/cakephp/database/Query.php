 ...
 */
namespace Onepix\FoodSpotVendor\Cake\Database;

use Onepix\FoodSpotVendor\Cake\Core\Exception\CakeException;
use Onepix\FoodSpotVendor\Cake\Database\Expression\CommonTableExpression;
use Onepix\FoodSpotVendor\Cake\Database\Expression\IdentifierExpression;
use Onepix\FoodSpotVendor\Cake\Database\Expression\OrderByExpression;
use Onepix\FoodSpotVendor\Cake\Database\Expression\OrderClauseExpression;
use Onepix\FoodSpotVendor\Cake\Database\Expression\QueryExpression;
use Closure;
use InvalidArgumentException;
use Stringable;
use Throwable;
use function Onepix\FoodSpotVendor\Cake\Core\deprecationWarning;
...
abstract class Query implements ExpressionInterface, Stringable
{
     ...
     *
     * @var \Onepix\FoodSpotVendor\Cake\Database\Connection
     */
    ...
    /**
     * @var \Onepix\FoodSpotVendor\Cake\Database\StatementInterface|null
     */
     ...
     *
     * @var \Onepix\FoodSpotVendor\Cake\Database\ValueBinder|null
     */
     ...
     *
     * @var \Onepix\FoodSpotVendor\Cake\Database\FunctionsBuilder|null
     */
     ...
     * Constructor.
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Connection $connection The connection
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Connection $connection Connection instance
     * @return $this
     */
     ...
     *
     * @return \Onepix\FoodSpotVendor\Cake\Database\StatementInterface
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ValueBinder|null $binder Value binder that generates parameter placeholders
     * @return string
     */
     ...
     *
     * ```
     * $cte = new \Onepix\FoodSpotVendor\Cake\Database\Expression\CommonTableExpression(
     *     'cte',
     *     $connection
     *         ->selectQuery('*')
     *         ->from('articles')
     ...
     * ```
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Expression\CommonTableExpression|\Closure $cte The CTE to add.
     ...
     * ```
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|array|string $modifiers modifiers to be applied to the query
     ...
     * @see \Onepix\FoodSpotVendor\Cake\Database\TypeFactory
     * @return $this
     */
     ...
     *
     * @param array<string, string|\Onepix\FoodSpotVendor\Cake\Database\Query\SelectQuery>|string $table The table to join with
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|\Closure|array|string $conditions The conditions
     * to use for joining.
     ...
     * @return array<string, array{table: string|\Onepix\FoodSpotVendor\Cake\Database\Query\SelectQuery, conditions: \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|\Closure|array|string, type: string}>
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|\Closure|array|string|null $conditions The conditions to filter on.
     * @param array<string, string> $types Associative array of type names used to bind values to query
     * @param bool $overwrite whether to reset conditions with passed list or not
     * @see \Onepix\FoodSpotVendor\Cake\Database\TypeFactory
     * @see \Onepix\FoodSpotVendor\Cake\Database\Expression\QueryExpression
     * @return $this
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|array|string $fields A single field or expressions or a list of them
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|\Closure|array|string $conditions The conditions to add with AND.
     * @param array<string, string> $types Associative array of type names used to bind values to query
     * @see \Onepix\FoodSpotVendor\Cake\Database\Query::where()
     * @see \Onepix\FoodSpotVendor\Cake\Database\TypeFactory
     * @return $this
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|\Closure|array|string $fields fields to be added to the list
     * @param bool $overwrite whether to reset order with field list or not
     * @return $this
    ...
    {
        onepix_foodspotvendor_deprecationWarning('5.0.0', 'Query::order() is deprecated. Use Query::orderBy() instead.');
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|\Closure|string $field The field to order on.
    ...
    {
        onepix_foodspotvendor_deprecationWarning('5.0.0', 'Query::orderAsc() is deprecated. Use Query::orderByAsc() instead.');
    ...
    public function orderByAsc(ExpressionInterface|Closure|string $field, bool $overwrite = false)
    {
        ...
        /** @var \Onepix\FoodSpotVendor\Cake\Database\Expression\QueryExpression $queryExpr */
    ...
    {
        onepix_foodspotvendor_deprecationWarning('5.0.0', 'Query::orderDesc() is deprecated. Use Query::orderByDesc() instead.');
     ...
     * @return $this
     * @throws \Onepix\FoodSpotVendor\Cake\Core\Exception\CakeException If page number < 1.
     */
     ...
     * ```
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|int|null $limit number of records to be returned
     * @return $this
     */
     ...
     * ```
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|int|null $offset number of records to be skipped
     * @return $this
     */
     ...
     * @return \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|string|null $expression The expression to be appended
     * @return $this
     */
     ...
     * ```
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|array|string|null $rawExpression A string, array or anything you want wrapped in an expression object
     * @return \Onepix\FoodSpotVendor\Cake\Database\Expression\QueryExpression
     */
     ...
     * ```
     *
     * @return \Onepix\FoodSpotVendor\Cake\Database\FunctionsBuilder
     */
     ...
     *
     * @return \Onepix\FoodSpotVendor\Cake\Database\ValueBinder
     */
     ...
     * to the statement object.
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ValueBinder|null $binder The binder or null to disable binding.
     * @return $this
     */
     ...
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|\Closure|array|string|null $append Expression or builder function to append.
     *   to append.
    ...
    protected function _conjugate(
        ...
        /** @var \Onepix\FoodSpotVendor\Cake\Database\Expression\QueryExpression $expression */
