...
use Onepix\FoodSpotVendor\Cake\Database\Expression\UnaryExpression;
...
use Onepix\FoodSpotVendor\Cake\Database\Schema\SqlserverSchemaDialect;
use Onepix\FoodSpotVendor\Cake\Database\SqlserverCompiler;
use Onepix\FoodSpotVendor\Cake\Database\Statement\SqlserverStatement;
...
class Sqlserver extends Driver
{
     ...
     * {@inheritDoc}
     *
     * @return \Onepix\FoodSpotVendor\Cake\Database\SqlserverCompiler
     */
     ...
     * be used.
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query\SelectQuery<mixed> $original The query to wrap in a subquery.
     * @param int|null $limit The number of rows to fetch.
     * @param int|null $offset The number of rows to offset.
     * @return \Onepix\FoodSpotVendor\Cake\Database\Query\SelectQuery<mixed> Modified query object.
     */
    protected function _pagingSubquery(SelectQuery $original, ?int $limit, ?int $offset): SelectQuery
    {
        $field = '_cake_paging_._cake_page_rownum_';

        /** @var \Onepix\FoodSpotVendor\Cake\Database\Expression\OrderByExpression $originalOrder */
     ...
     * SQL dialect.
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Expression\FunctionExpression $expression The function expression to convert to TSQL.
     * @return void
     */
