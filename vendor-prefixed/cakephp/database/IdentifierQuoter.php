...
use Onepix\FoodSpotVendor\Cake\Database\Expression\FieldInterface;
...
class IdentifierQuoter
{
     ...
     * quotes them
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query $query The query to have its identifiers quoted
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface $expression The expression object to walk and quote.
     * @return void
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query $query The query to quote.
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query\SelectQuery<mixed> $query The query to quote.
     * @return void
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query\DeleteQuery $query The query to quote.
     * @return void
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query\InsertQuery $query The insert query to quote.
     * @return void
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query\UpdateQuery $query The update query to quote.
     * @return void
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Expression\FieldInterface $expression The expression to quote.
     * @return void
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Expression\OrderByExpression $expression The expression to quote.
     * @return void
     */
     ...
     * Quotes identifiers in "order by" expression objects
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Expression\IdentifierExpression $expression The identifiers to quote.
     * @return void
     */
