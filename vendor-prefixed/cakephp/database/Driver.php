...
use Onepix\FoodSpotVendor\Cake\Core\App;
use Onepix\FoodSpotVendor\Cake\Core\Exception\CakeException;
use Onepix\FoodSpotVendor\Cake\Core\Retry\CommandRetry;
use Onepix\FoodSpotVendor\Cake\Database\Exception\DatabaseException;
use Onepix\FoodSpotVendor\Cake\Database\Exception\MissingConnectionException;
use Onepix\FoodSpotVendor\Cake\Database\Exception\QueryException;
use Onepix\FoodSpotVendor\Cake\Database\Expression\ComparisonExpression;
use Onepix\FoodSpotVendor\Cake\Database\Expression\IdentifierExpression;
use Onepix\FoodSpotVendor\Cake\Database\Log\LoggedQuery;
use Onepix\FoodSpotVendor\Cake\Database\Log\QueryLogger;
...
use Onepix\FoodSpotVendor\Cake\Database\Retry\ErrorCodeWaitStrategy;
use Onepix\FoodSpotVendor\Cake\Database\Schema\SchemaDialect;
use Onepix\FoodSpotVendor\Cake\Database\Schema\TableSchema;
use Onepix\FoodSpotVendor\Cake\Database\Schema\TableSchemaInterface;
use Onepix\FoodSpotVendor\Cake\Database\Statement\Statement;
...
abstract class Driver implements LoggerAwareInterface
{
    ...
    /**
     * @var class-string<\Onepix\FoodSpotVendor\Cake\Database\Statement\Statement>
     */
     ...
     * Identifier quoter
     *
     * @var \Onepix\FoodSpotVendor\Cake\Database\IdentifierQuoter|null
     */
     ...
     *
     * @var \Onepix\FoodSpotVendor\Cake\Database\Schema\SchemaDialect
     */
     ...
     * Establishes a connection to the database server.
     *
     * @throws \Onepix\FoodSpotVendor\Cake\Database\Exception\MissingConnectionException If database connection could not be established.
     * @return void
     */
     ...
     * @return \Onepix\FoodSpotVendor\Cake\Database\StatementInterface Executed statement
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query $query The query to be executed.
     * @return \Onepix\FoodSpotVendor\Cake\Database\StatementInterface Executed statement
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\StatementInterface $statement Statement to execute.
     ...
     * @param \Onepix\FoodSpotVendor\Cake\Database\StatementInterface $statement
     * @param array|null $params
     * @return \Onepix\FoodSpotVendor\Cake\Database\Exception\QueryException
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query|string $query The query to turn into a prepared statement.
    ...
    public function prepare(Query|string $query): StatementInterface
    {
        ...
        /** @var \Onepix\FoodSpotVendor\Cake\Database\StatementInterface */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query|string $query The query to be decorated.
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query $query Query to transform.
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query\SelectQuery<mixed> $query The query to translate
     * @return \Onepix\FoodSpotVendor\Cake\Database\Query\SelectQuery<mixed> The modified query
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query\SelectQuery<mixed> $query The query to be transformed
     * @return \Onepix\FoodSpotVendor\Cake\Database\Query\SelectQuery<mixed>
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query\DeleteQuery $query The query to translate
     * @return \Onepix\FoodSpotVendor\Cake\Database\Query\DeleteQuery The modified query
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query\UpdateQuery $query The query to translate
     * @return \Onepix\FoodSpotVendor\Cake\Database\Query\UpdateQuery The modified query
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query\UpdateQuery|\Onepix\FoodSpotVendor\Cake\Database\Query\DeleteQuery $query The query to process.
     * @return \Onepix\FoodSpotVendor\Cake\Database\Query\UpdateQuery|\Onepix\FoodSpotVendor\Cake\Database\Query\DeleteQuery The modified query.
     * @throws \Onepix\FoodSpotVendor\Cake\Database\Exception\DatabaseException In case the processed query contains any joins, as removing
     *  aliases from the conditions can break references to the joined tables.
     * @template T of \Cake\Database\Query\UpdateQuery|\Onepix\FoodSpotVendor\Cake\Database\Query\DeleteQuery
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query\InsertQuery $query The query to translate
     * @return \Onepix\FoodSpotVendor\Cake\Database\Query\InsertQuery The modified query
     */
     ...
     *
     * @return \Onepix\FoodSpotVendor\Cake\Database\Schema\SchemaDialect
     */
     ...
     *
     * @return \Onepix\FoodSpotVendor\Cake\Database\IdentifierQuoter
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\DriverFeatureEnum $feature Driver feature
     * @return bool
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query $query The query to compile.
    ...
    /**
     * @return \Onepix\FoodSpotVendor\Cake\Database\QueryCompiler
     */
     ...
     * @return \Onepix\FoodSpotVendor\Cake\Database\Schema\TableSchemaInterface
     */
    public function newTableSchema(string $table, array $columns = []): TableSchemaInterface
    {
        /** @var class-string<\Onepix\FoodSpotVendor\Cake\Database\Schema\TableSchemaInterface> $className */
     ...
     *
     * @return \Onepix\FoodSpotVendor\Psr\Log\LoggerInterface|null
     */
    ...
    protected function createLogger(?string $className): LoggerInterface
    {
        ...
        /** @var class-string<\Onepix\FoodSpotVendor\Psr\Log\LoggerInterface>|null $className */
        $className = App::className($className, 'Cake/Log', 'Log');
        if ($className === null) {
            throw new CakeException(
                'For logging you must either set the `log` config to a FQCN which implements Onepix\FoodSpotVendor\Psr\Log\LoggerInterface' .
