...
class OrderByExpression extends QueryExpression
{
     ...
     * Constructor
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|array|string $conditions The sort columns
     * @param \Onepix\FoodSpotVendor\Cake\Database\TypeMap|array<string, string> $types The types for each column.
