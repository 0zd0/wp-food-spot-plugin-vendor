...
interface WindowInterface
{
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|\Closure|array<\Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|string>|string $partitions Partition expressions
     * @return $this
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|\Closure|array<\Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|string>|string $fields Order expressions
     * @return $this
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|string|int|null $start Frame start
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|string|int|null $end Frame end
     ...
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|string|int|null $startOffset Frame start offset
     * @param string $startDirection Frame start direction
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|string|int|null $endOffset Frame end offset
