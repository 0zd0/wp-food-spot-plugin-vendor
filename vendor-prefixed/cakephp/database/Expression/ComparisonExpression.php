...
class ComparisonExpression implements ExpressionInterface, FieldInterface
{
     ...
     * Constructor
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|string $field the field name to compare to a value
     ...
     * position.
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|iterable $values The rows to insert
     * @return array
     */
