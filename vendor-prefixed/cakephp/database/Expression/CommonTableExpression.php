...
class CommonTableExpression implements ExpressionInterface
{
     ...
     * The CTE name.
     *
     * @var \Onepix\FoodSpotVendor\Cake\Database\Expression\IdentifierExpression
     */
     ...
     *
     * @var array<\Onepix\FoodSpotVendor\Cake\Database\Expression\IdentifierExpression>
     */
     ...
     *
     * @var \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|null
     */
     ...
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|\Closure|null $query CTE query
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|\Closure $query CTE query
     * @return $this
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Expression\IdentifierExpression|array<string>|array<\Onepix\FoodSpotVendor\Cake\Database\Expression\IdentifierExpression>|string $fields Field names
     * @return $this
     */
    public function field(IdentifierExpression|array|string $fields)
    {
        $fields = (array)$fields;
        /** @var array<string|\Onepix\FoodSpotVendor\Cake\Database\Expression\IdentifierExpression> $fields */
        foreach ($fields as &$field) {
            if (!($field instanceof IdentifierExpression)) {
                $field = new IdentifierExpression($field);
            }
        }
        /** @var array<\Onepix\FoodSpotVendor\Cake\Database\Expression\IdentifierExpression> $mergedFields */
