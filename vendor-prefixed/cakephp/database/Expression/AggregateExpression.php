...
{
    /**
     * @var \Onepix\FoodSpotVendor\Cake\Database\Expression\QueryExpression|null
     */
    protected ?QueryExpression $filter = null;

    /**
     * @var \Onepix\FoodSpotVendor\Cake\Database\Expression\WindowExpression|null
     */
     ...
     * `Query::where()`.
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|\Closure|array|string $conditions The conditions to filter on.
     ...
     *
     * @return \Onepix\FoodSpotVendor\Cake\Database\Expression\WindowExpression
     */
