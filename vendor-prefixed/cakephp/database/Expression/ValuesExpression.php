...
class ValuesExpression implements ExpressionInterface
{
     ...
     *
     * @var \Onepix\FoodSpotVendor\Cake\Database\Query|null
     */
     ...
     * @param \Onepix\FoodSpotVendor\Cake\Database\TypeMap $typeMap A dictionary of column -> type names
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query|array $values Array of data to append into the insert, or
     *   a query for doing INSERT INTO .. SELECT style commands
     * @return void
     * @throws \Onepix\FoodSpotVendor\Cake\Database\Exception\DatabaseException When mixing array and Query data types.
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Query $query The query to set
     * @return $this
     */
     ...
     * to insert records in the table.
     *
     * @return \Onepix\FoodSpotVendor\Cake\Database\Query|null
     */
    ...
    protected function _processExpressions(): void
    {
        ...
        foreach ($this->_values as $row => $values) {
            foreach ($types as $col => $type) {
                /** @var \Onepix\FoodSpotVendor\Cake\Database\Type\ExpressionTypeInterface $type */
