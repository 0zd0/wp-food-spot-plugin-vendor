...
use Onepix\FoodSpotVendor\Cake\Database\TypeMapTrait;
...
class QueryExpression implements ExpressionInterface, Countable
{
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|array|string $conditions Tree like array structure
     * containing all the conditions to be added or nested inside this expression object.
     * @param \Onepix\FoodSpotVendor\Cake\Database\TypeMap|array $types Associative array of types to be associated with the values
     * passed in $conditions.
     * @param string $conjunction the glue that will join all the string conditions at this
     * level of the expression tree. For example "AND", "OR", "XOR"...
     * @see \Onepix\FoodSpotVendor\Cake\Database\Expression\QueryExpression::add() for more details on $conditions and $types
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|array|string $conditions single or multiple conditions to
     ...
     * @see \Onepix\FoodSpotVendor\Cake\Database\Query::where() for examples on conditions
     * @return $this
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|string $field Database field to be compared against value
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|string $field database field to be
     * tested for null
     * @return $this
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|string $field Database field to be compared against value
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|array|string $values the value to be bound to $field for comparison
     * @param string|null $type the type name for $value as configured using the Type map.
     * @return $this
     */
    public function in(
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|object|scalar|null $value The case value.
     * @param string|null $type The case value type. If no type is provided, the type will be tried to be inferred
     *  from the value.
     * @return \Onepix\FoodSpotVendor\Cake\Database\Expression\CaseStatementExpression
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface $expression the inner query
     * @return $this
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|\Closure|array|string $conditions to be joined with AND
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|\Closure|array|string $conditions to be joined with OR
     * @param array<string, string> $types Associative array of fields pointing to the type of the
     * values that are being passed. Used for correctly binding values to statements.
     * @return static
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|\Closure|array|string $conditions to be added and negated
     * @param array<string, string> $types Associative array of fields pointing to the type of the
     * values that are being passed. Used for correctly binding values to statements.
     * @return $this
     */
     ...
     * @return \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|string
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|string $field The field name to get a type for.
