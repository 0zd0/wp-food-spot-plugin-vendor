...
class CaseStatementExpression implements ExpressionInterface, TypedResultInterface
{
     ...
     *
     * @var array<\Onepix\FoodSpotVendor\Cake\Database\Expression\WhenThenExpression>
     */
     ...
     * $queryExpression
     *     ->case()
     *     ->when(function (\Onepix\FoodSpotVendor\Cake\Database\Expression\WhenThenExpression $whenThen) {
     *         return $whenThen
     ...
     * ```
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|\Closure|object|array|scalar $when The `WHEN` value. When using an
     ...
     * @return \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|object|array<\Onepix\FoodSpotVendor\Cake\Database\Expression\WhenThenExpression>|scalar|null
