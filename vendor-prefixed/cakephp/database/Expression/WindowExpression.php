...
class WindowExpression implements ExpressionInterface, WindowInterface
{
    ...
    /**
     * @var array<\Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface>
     */
    protected array $partitions = [];

    /**
     * @var \Onepix\FoodSpotVendor\Cake\Database\Expression\OrderByExpression|null
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ValueBinder $binder Value binder
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|string|int|null $offset Frame offset
