...
class TypeFactory
{
     ...
     * @phpstan-var array<string, class-string<\Onepix\FoodSpotVendor\Cake\Database\TypeInterface>>
     */
     ...
     *
     * @var array<\Onepix\FoodSpotVendor\Cake\Database\TypeInterface>
     */
     ...
     * @return \Onepix\FoodSpotVendor\Cake\Database\TypeInterface
     */
     ...
     *
     * @return array<\Onepix\FoodSpotVendor\Cake\Database\TypeInterface>
     */
     ...
     * @param \Onepix\FoodSpotVendor\Cake\Database\TypeInterface $instance The type instance you want to set.
     * @return void
     */
     ...
     * @return void
     * @phpstan-param class-string<\Onepix\FoodSpotVendor\Cake\Database\TypeInterface> $className
     */
     ...
     * @return void
     * @phpstan-param array<string, class-string<\Onepix\FoodSpotVendor\Cake\Database\TypeInterface>> $map
     */
     ...
     * @return array<string, class-string<\Onepix\FoodSpotVendor\Cake\Database\TypeInterface>>|string|null Configured class name for given $type or map array.
     */
