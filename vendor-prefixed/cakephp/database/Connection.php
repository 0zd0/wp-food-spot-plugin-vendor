...
use Onepix\FoodSpotVendor\Cake\Database\Exception\MissingDriverException;
use Onepix\FoodSpotVendor\Cake\Database\Exception\MissingExtensionException;
use Onepix\FoodSpotVendor\Cake\Database\Exception\NestedTransactionRollbackException;
use Onepix\FoodSpotVendor\Cake\Database\Query\DeleteQuery;
use Onepix\FoodSpotVendor\Cake\Database\Query\InsertQuery;
use Onepix\FoodSpotVendor\Cake\Database\Query\QueryFactory;
use Onepix\FoodSpotVendor\Cake\Database\Query\SelectQuery;
use Onepix\FoodSpotVendor\Cake\Database\Query\UpdateQuery;
use Onepix\FoodSpotVendor\Cake\Database\Retry\ReconnectStrategy;
use Onepix\FoodSpotVendor\Cake\Database\Schema\CachedCollection;
use Onepix\FoodSpotVendor\Cake\Database\Schema\Collection as SchemaCollection;
use Onepix\FoodSpotVendor\Cake\Database\Schema\CollectionInterface as SchemaCollectionInterface;
use Onepix\FoodSpotVendor\Cake\Datasource\ConnectionInterface;
use Cake\Log\Log;
use Closure;
use Onepix\FoodSpotVendor\Psr\SimpleCache\CacheInterface;
use Throwable;
use function Onepix\FoodSpotVendor\Cake\Core\env;
...
class Connection implements ConnectionInterface
{
     ...
     *
     * @var \Onepix\FoodSpotVendor\Psr\SimpleCache\CacheInterface|null
     */
     ...
     *
     * @var \Onepix\FoodSpotVendor\Cake\Database\Schema\CollectionInterface|null
     */
     ...
     *
     * @var \Onepix\FoodSpotVendor\Cake\Database\Exception\NestedTransactionRollbackException|null
     */
     ...
     * @return array<string, \Onepix\FoodSpotVendor\Cake\Database\Driver>
     * @phpstan-return array{read: \Onepix\FoodSpotVendor\Cake\Database\Driver, write: \Onepix\FoodSpotVendor\Cake\Database\Driver}
     */
    protected function createDrivers(array $config): array
    {
        ...
        /** @var class-string<\Onepix\FoodSpotVendor\Cake\Database\Driver>|null $driverClass */
    ...
    public function __destruct()
    {
        if ($this->_transactionStarted && class_exists(Log::class)) {
            ...
            $requestUrl = onepix_foodspotvendor_env('REQUEST_URI');
            if ($requestUrl) {
                $message .= "\nRequest URL: " . $requestUrl;
            }

            $clientIp = onepix_foodspotvendor_env('REMOTE_ADDR');
            if ($clientIp) {
                $message .= "\nClient IP: " . $clientIp;
            }
     ...
     *
     * @return \Onepix\FoodSpotVendor\Cake\Core\Retry\CommandRetry The retry wrapper
     */
     ...
     * @return \Onepix\FoodSpotVendor\Cake\Database\Driver
     */
     ...
     *
     * @return \Onepix\FoodSpotVendor\Cake\Database\Query\QueryFactory
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|\Closure|array|string|float|int $fields Fields/columns list for the query.
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\ExpressionInterface|string|null $table The table to update rows of.
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Schema\CollectionInterface $collection The schema collection object
     * @return $this
     */
     ...
     *
     * @return \Onepix\FoodSpotVendor\Cake\Database\Schema\CollectionInterface
     */
