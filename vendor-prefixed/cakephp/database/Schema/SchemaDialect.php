...
use Onepix\FoodSpotVendor\Cake\Database\Type\ColumnSchemaAwareInterface;
...
abstract class SchemaDialect
{
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Driver $driver The driver to use.
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Schema\TableSchema $schema Schema instance
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Schema\TableSchema $schema The table object to append fields to.
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Schema\TableSchema $schema The table object the column is in.
     * @param string $name The name of the column.
     * @return string SQL fragment.
     */
    ...
    {
        onepix_foodspotvendor_deprecationWarning(
            '5.2.0',
    ...
    public function describeColumns(string $tableName): array
    {
        ...
        /** @var \Onepix\FoodSpotVendor\Cake\Database\Schema\TableSchema $table */
        $table = $this->_driver->newTableSchema($tableName);
