 ...
 */
namespace Onepix\FoodSpotVendor\Cake\Database\Retry;

use Onepix\FoodSpotVendor\Cake\Core\Retry\RetryStrategyInterface;
...
class ReconnectStrategy implements RetryStrategyInterface
{
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Database\Connection $connection The connection to check
     */
