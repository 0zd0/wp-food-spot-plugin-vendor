...
interface FixtureInterface
{
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Datasource\ConnectionInterface $connection An instance of the connection
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Datasource\ConnectionInterface $connection A reference to a db instance
     * @return bool
     */
