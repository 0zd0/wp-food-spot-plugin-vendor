 ...
 * @method \Onepix\FoodSpotVendor\Cake\Datasource\EntityInterface|array firstOrFail() Get the first result from the executing query or raise an exception.
...
interface QueryInterface
{
     ...
     *
     * @param array<int|string, string|\Onepix\FoodSpotVendor\Cake\Database\Expression\IdentifierExpression> $fields The fields to alias
     * @param string|null $defaultAlias The default alias
     * @return array<int|string, string|\Onepix\FoodSpotVendor\Cake\Database\Expression\IdentifierExpression>
     */
     ...
     *
     * @template T of mixed
     * @return \Onepix\FoodSpotVendor\Cake\Datasource\ResultSetInterface<T>
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Datasource\RepositoryInterface $repository The default repository object to use
     * @return $this
     */
     ...
     *
     * @return \Onepix\FoodSpotVendor\Cake\Datasource\RepositoryInterface|null $repository The default repository object to use
     */
