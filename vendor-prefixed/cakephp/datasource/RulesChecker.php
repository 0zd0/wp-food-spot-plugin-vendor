...
class RulesChecker
{
     ...
     *
     * @var array<\Onepix\FoodSpotVendor\Cake\Datasource\RuleInvoker>
     */
     ...
     * second argument.
     * @return $this
     * @throws \Onepix\FoodSpotVendor\Cake\Core\Exception\CakeException If a rule with the same name already exists
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Datasource\EntityInterface $entity The entity to check for validity.
     ...
     * @param \Onepix\FoodSpotVendor\Cake\Datasource\EntityInterface $entity The entity to check for validity.
     * @param array<string, mixed> $options Extra options to pass to checker functions.
     * @param array<\Onepix\FoodSpotVendor\Cake\Datasource\RuleInvoker> $rules The list of rules that must be checked.
     * @return bool
     */
     ...
     * @return \Onepix\FoodSpotVendor\Cake\Datasource\RuleInvoker
     */
     ...
     * @param array<\Onepix\FoodSpotVendor\Cake\Datasource\RuleInvoker> $rules The rules array to check
     * @return void
     * @throws \Onepix\FoodSpotVendor\Cake\Core\Exception\CakeException
     */
