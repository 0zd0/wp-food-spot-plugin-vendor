...
use Onepix\FoodSpotVendor\Cake\Datasource\Exception\MissingModelException;
use Onepix\FoodSpotVendor\Cake\Datasource\Locator\LocatorInterface;
use UnexpectedValueException;
use function Onepix\FoodSpotVendor\Cake\Core\pluginSplit;
...
trait ModelAwareTrait
{
     ...
     *
     * @var array<callable|\Onepix\FoodSpotVendor\Cake\Datasource\Locator\LocatorInterface>
     */
     ...
     * @return \Onepix\FoodSpotVendor\Cake\Datasource\RepositoryInterface The model instance created.
     * @throws \Onepix\FoodSpotVendor\Cake\Datasource\Exception\MissingModelException If the model class cannot be found.
    ...
    public function fetchModel(?string $modelClass = null, ?string $modelType = null): RepositoryInterface
    {
        ...
        if (!str_contains($modelClass, '\\')) {
            [, $alias] = onepix_foodspotvendor_pluginSplit($modelClass, true);
        } else {
     ...
     * @param \Onepix\FoodSpotVendor\Cake\Datasource\Locator\LocatorInterface|callable $factory The factory function used to create instances.
     * @return void
     */
