...
use Onepix\FoodSpotVendor\Cake\Core\StaticConfigTrait;
use Onepix\FoodSpotVendor\Cake\Database\Connection;
use Onepix\FoodSpotVendor\Cake\Database\Driver\Mysql;
use Onepix\FoodSpotVendor\Cake\Database\Driver\Postgres;
use Onepix\FoodSpotVendor\Cake\Database\Driver\Sqlite;
use Onepix\FoodSpotVendor\Cake\Database\Driver\Sqlserver;
use Onepix\FoodSpotVendor\Cake\Datasource\Exception\MissingDatasourceConfigException;
use Closure;
...
class ConnectionManager
{
     ...
     *
     * @var \Onepix\FoodSpotVendor\Cake\Datasource\ConnectionRegistry
     */
     ...
     * @param \Onepix\FoodSpotVendor\Cake\Datasource\ConnectionInterface|\Closure|array<string, mixed>|null $config An array of name => config data for adapter.
     * @return void
     * @throws \Onepix\FoodSpotVendor\Cake\Core\Exception\CakeException When trying to modify an existing config.
     * @see \Onepix\FoodSpotVendor\Cake\Core\StaticConfigTrait::config()
     */
     ...
     *
     * $dsn = 'Onepix\FoodSpotVendor\Cake\Database\Driver\Mysql://localhost:3306/database?className=Onepix\FoodSpotVendor\Cake\Database\Connection';
     * $config = ConnectionManager::parseDsn($dsn);
     *
     * $dsn = 'Onepix\FoodSpotVendor\Cake\Database\Connection://localhost:3306/database?driver=Onepix\FoodSpotVendor\Cake\Database\Driver\Mysql';
     * $config = ConnectionManager::parseDsn($dsn);
     * ```
     *
     ...
     * @return \Onepix\FoodSpotVendor\Cake\Datasource\ConnectionInterface
     * @throws \Onepix\FoodSpotVendor\Cake\Datasource\Exception\MissingDatasourceConfigException When config
     * data is missing.
     */
