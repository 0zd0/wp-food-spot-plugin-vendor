 ...
 *
 * @internal
 * @see \Onepix\FoodSpotVendor\Cake\Datasource\QueryTrait::cache() for the public interface.
 */
class QueryCacher
{
    /**
     ...
     *
     * @var \Onepix\FoodSpotVendor\Psr\SimpleCache\CacheInterface|string
     */
     ...
     * @param \Onepix\FoodSpotVendor\Psr\SimpleCache\CacheInterface|string $config The cache config name or cache engine instance.
     */
     ...
     *
     * @return \Onepix\FoodSpotVendor\Psr\SimpleCache\CacheInterface
     */
