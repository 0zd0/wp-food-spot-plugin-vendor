 ...
 */
namespace Onepix\FoodSpotVendor\Cake\Datasource\Paging;

use Onepix\FoodSpotVendor\Cake\Core\Exception\CakeException;
use Onepix\FoodSpotVendor\Cake\Core\InstanceConfigTrait;
use Onepix\FoodSpotVendor\Cake\Datasource\Paging\Exception\PageOutOfBoundsException;
use Onepix\FoodSpotVendor\Cake\Datasource\QueryInterface;
use Onepix\FoodSpotVendor\Cake\Datasource\RepositoryInterface;
use Onepix\FoodSpotVendor\Cake\Datasource\ResultSetInterface;
use function Onepix\FoodSpotVendor\Cake\Core\triggerWarning;
...
class NumericPaginator implements PaginatorInterface
{
     ...
     * @return \Onepix\FoodSpotVendor\Cake\Datasource\Paging\PaginatedInterface
     * @throws \Onepix\FoodSpotVendor\Cake\Datasource\Paging\Exception\PageOutOfBoundsException
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Datasource\ResultSetInterface $items
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Datasource\RepositoryInterface $object Repository instance.
     * @param \Onepix\FoodSpotVendor\Cake\Datasource\QueryInterface|null $query Query Instance.
     * @param array<string, mixed> $data Pagination data.
     * @return \Onepix\FoodSpotVendor\Cake\Datasource\QueryInterface
     */
     ...
     * Get paginated items.
     *
     * @param \Onepix\FoodSpotVendor\Cake\Datasource\QueryInterface $query Query to fetch items.
     * @param array $data Paging data.
     * @return \Onepix\FoodSpotVendor\Cake\Datasource\ResultSetInterface
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Datasource\QueryInterface $query Query instance.
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Datasource\RepositoryInterface $object The repository object.
    ...
    protected function extractData(RepositoryInterface $object, array $params, array $settings): array
    {
        ...
        if ($extraSettings) {
            onepix_foodspotvendor_triggerWarning(
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Datasource\RepositoryInterface $object Repository object.
