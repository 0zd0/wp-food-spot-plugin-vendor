...
use Onepix\FoodSpotVendor\Cake\Utility\Crypto\OpenSsl;
...
class Security
{
     ...
     * @return void
     * @see \Onepix\FoodSpotVendor\Cake\Utility\Security::hash()
     */
     ...
     * @param int $length The number of bytes you want.
     * @return string Random bytes in binary.
     * @see \Onepix\FoodSpotVendor\Cake\Utility\Security::randomBytes()
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Utility\Crypto\OpenSsl|null $instance The crypto instance to use.
     * @return \Onepix\FoodSpotVendor\Cake\Utility\Crypto\OpenSsl Crypto instance.
    ...
    public static function engine(?object $instance = null): object
    {
        ...
        if (isset(static::$_instance)) {
            /** @var \Onepix\FoodSpotVendor\Cake\Utility\Crypto\OpenSsl */
