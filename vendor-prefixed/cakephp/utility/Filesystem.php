...
class Filesystem
{
     ...
     * @return void
     * @throws \Onepix\FoodSpotVendor\Cake\Core\Exception\CakeException When dumping fails.
     */
     ...
     * @return void
     * @throws \Onepix\FoodSpotVendor\Cake\Core\Exception\CakeException When directory creation fails.
     */
     ...
     * @param string $path Directory path.
     * @return bool
     * @throws \Onepix\FoodSpotVendor\Cake\Core\Exception\CakeException If path is not a directory.
     */
