...
namespace Onepix\FoodSpotVendor\Cake\Chronos;
...
class ChronosDate implements Stringable
{
     ...
     *
     * @var \Onepix\FoodSpotVendor\Cake\Chronos\DifferenceFormatterInterface|null
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Chronos\ChronosDate|\DateTimeInterface|string $time Fixed or relative time
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Chronos\ChronosDate|\DateTimeInterface|string $time The strtotime compatible string to parse
     * @return static
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Chronos\DifferenceFormatterInterface|null $formatter The formatter instance when setting.
     * @return \Onepix\FoodSpotVendor\Cake\Chronos\DifferenceFormatterInterface The formatter instance.
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Chronos\ChronosDate $target Target instance
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Chronos\ChronosDate $other The instance to compare with.
     * @return bool
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Chronos\ChronosDate $start Start of target range
     * @param \Onepix\FoodSpotVendor\Cake\Chronos\ChronosDate $end End of target range
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Chronos\ChronosDate $first The instance to compare with.
     * @param \Onepix\FoodSpotVendor\Cake\Chronos\ChronosDate $second The instance to compare with.
     * @param \Onepix\FoodSpotVendor\Cake\Chronos\ChronosDate ...$others Others instance to compare with.
     * @return self
     */
     ...
     * @param \Onepix\FoodSpotVendor\Cake\Chronos\ChronosDate|null $other The instance to difference from.
     ...
     * 5 months after
     *
     * @param \Onepix\FoodSpotVendor\Cake\Chronos\ChronosDate|null $other The datetime to compare with.
