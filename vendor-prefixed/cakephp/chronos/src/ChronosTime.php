...
class ChronosTime implements Stringable
{
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Chronos\ChronosTime|\DateTimeInterface|string|null $time Time
     ...
     * Defaults to server time.
     *
     * @param \Onepix\FoodSpotVendor\Cake\Chronos\ChronosTime|\DateTimeInterface|string $time Time
     * @param \DateTimeZone|string|null $timezone The timezone to use for now
     * @return static
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Chronos\ChronosTime $target Target time
     * @return bool
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Chronos\ChronosTime $start Start of target range
     * @param \Onepix\FoodSpotVendor\Cake\Chronos\ChronosTime $end End of target range
