...
use Onepix\FoodSpotVendor\Cake\Core\Configure\Engine\PhpConfig;
...
class Configure
{
     ...
     *
     * @see \Onepix\FoodSpotVendor\Cake\Core\Configure::load()
     * @var array<\Onepix\FoodSpotVendor\Cake\Core\Configure\ConfigEngineInterface>
     */
     ...
     * Alternatively can be an array containing key(s) and onepix_foodspotvendor_value(s).
     ...
     * @throws \Onepix\FoodSpotVendor\Cake\Core\Exception\CakeException if the requested configuration is not set.
     * @link https://book.cakephp.org/5/en/development/configuration.html#reading-configuration-data
     */
     ...
     * @param \Onepix\FoodSpotVendor\Cake\Core\Configure\ConfigEngineInterface $engine The engine to append.
     * @return void
     */
     ...
     * @throws \Onepix\FoodSpotVendor\Cake\Core\Exception\CakeException if the $config engine is not found
     ...
     * @return bool Success
     * @throws \Onepix\FoodSpotVendor\Cake\Core\Exception\CakeException if the adapter does not implement a `dump` method.
     */
     ...
     * @return \Onepix\FoodSpotVendor\Cake\Core\Configure\ConfigEngineInterface|null Engine instance or null
     */
