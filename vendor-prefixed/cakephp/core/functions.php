...
if (!function_exists('Onepix\FoodSpotVendor\Cake\Core\pathCombine')) {
    /**
...
if (!function_exists('Onepix\FoodSpotVendor\Cake\Core\h')) {
    /**
    ...
    function onepix_foodspotvendor_h(mixed $text, bool $double = true, ?string $charset = null): mixed
    {
        if (is_string($text)) {
            ...
            $texts = [];
            foreach ($text as $k => $t) {
                $texts[$k] = onepix_foodspotvendor_h($t, $double, $charset);
            }
...
if (!function_exists('Onepix\FoodSpotVendor\Cake\Core\pluginSplit')) {
    /**
...
if (!function_exists('Onepix\FoodSpotVendor\Cake\Core\namespaceSplit')) {
    /**
...
if (!function_exists('Onepix\FoodSpotVendor\Cake\Core\pr')) {
    /**
...
if (!function_exists('Onepix\FoodSpotVendor\Cake\Core\pj')) {
    /**
...
if (!function_exists('Onepix\FoodSpotVendor\Cake\Core\env')) {
    /**
    ...
    function onepix_foodspotvendor_env(string $key, string|float|int|bool|null $default = null): string|float|int|bool|null
    {
        ...
        if ($key === 'REMOTE_ADDR' && $val === onepix_foodspotvendor_env('SERVER_ADDR')) {
            $addr = onepix_foodspotvendor_env('HTTP_PC_REMOTE_ADDR');
            if ($addr !== null) {
                $val = $addr;
            }
        }
...
if (!function_exists('Onepix\FoodSpotVendor\Cake\Core\triggerWarning')) {
    /**
...
if (!function_exists('Onepix\FoodSpotVendor\Cake\Core\deprecationWarning')) {
    /**
...
if (!function_exists('Onepix\FoodSpotVendor\Cake\Core\toString')) {
    /**
...
if (!function_exists('Onepix\FoodSpotVendor\Cake\Core\toInt')) {
    /**
...
if (!function_exists('Onepix\FoodSpotVendor\Cake\Core\toFloat')) {
    /**
...
if (!function_exists('Onepix\FoodSpotVendor\Cake\Core\toBool')) {
    /**
