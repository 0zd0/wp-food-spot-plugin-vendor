...
use Onepix\FoodSpotVendor\Cake\Core\Exception\MissingPluginException;
 ...
 *
 * @template-implements \Iterator<string, \Onepix\FoodSpotVendor\Cake\Core\PluginInterface>
 */
class PluginCollection implements Iterator, Countable
{
     ...
     * Plugin list
     *
     * @var array<\Onepix\FoodSpotVendor\Cake\Core\PluginInterface>
     */
     ...
     * Constructor
     *
     * @param array<\Onepix\FoodSpotVendor\Cake\Core\PluginInterface> $plugins The map of plugins to add to the collection.
     */
     ...
     * @return string
     * @throws \Onepix\FoodSpotVendor\Cake\Core\Exception\MissingPluginException when a plugin path cannot be resolved.
     * @internal
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Cake\Core\PluginInterface $plugin The plugin to load.
     * @return $this
     */
     ...
     * @return \Onepix\FoodSpotVendor\Cake\Core\PluginInterface The plugin.
     * @throws \Onepix\FoodSpotVendor\Cake\Core\Exception\MissingPluginException when unknown plugins are fetched.
     */
     ...
     * @return \Onepix\FoodSpotVendor\Cake\Core\PluginInterface
     * @throws \Onepix\FoodSpotVendor\Cake\Core\Exception\MissingPluginException When plugin instance could not be created.
     * @throws \InvalidArgumentException When class name cannot be found.
     * @phpstan-param class-string<\Onepix\FoodSpotVendor\Cake\Core\PluginInterface>|string $name
     */
    public function create(string $name, array $config = []): PluginInterface
    {
        ...
        if (str_contains($name, '\\')) {
            ...
            /** @var \Onepix\FoodSpotVendor\Cake\Core\PluginInterface */
        ...
        /** @var class-string<\Onepix\FoodSpotVendor\Cake\Core\PluginInterface> $className */
