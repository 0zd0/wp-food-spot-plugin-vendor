...
namespace Onepix\FoodSpotVendor\Phinx\Config;
...
class Config implements ConfigInterface, NamespaceAwareInterface
{
    ...
    {
        $className = !isset($this->values['migration_base_class']) ? 'Onepix\FoodSpotVendor\Phinx\Migration\AbstractMigration' : $this->values['migration_base_class'];
    ...
    {
        $className = !isset($this->values['seed_base_class']) ? 'Onepix\FoodSpotVendor\Phinx\Seed\AbstractSeed' : $this->values['seed_base_class'];
