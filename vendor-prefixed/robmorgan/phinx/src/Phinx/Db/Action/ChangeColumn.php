...
class ChangeColumn extends Action
{
     ...
     * Constructor
     *
     * @param \Onepix\FoodSpotVendor\Phinx\Db\Table\Table $table The table to alter
     * @param string $columnName The name of the column to change
     * @param \Onepix\FoodSpotVendor\Phinx\Db\Table\Column $column The column definition
     */
     ...
     * @param \Onepix\FoodSpotVendor\Phinx\Db\Table\Table $table The table to alter
     * @param string $columnName The name of the column to change
     * @param string|\Onepix\FoodSpotVendor\Phinx\Util\Literal $type The type of the column
