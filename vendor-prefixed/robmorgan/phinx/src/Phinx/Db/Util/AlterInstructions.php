...
namespace Onepix\FoodSpotVendor\Phinx\Db\Util;
...
class AlterInstructions
{
     ...
     *
     * @param \Onepix\FoodSpotVendor\Phinx\Db\Util\AlterInstructions $other The other collection of instructions to merge in
     * @return void
     */
