...
use Onepix\FoodSpotVendor\Cake\Database\Driver\Sqlserver as SqlServerDriver;
...
SQL;
     ...
     * @param \Onepix\FoodSpotVendor\Phinx\Db\Table\Column $newColumn The column to alter
