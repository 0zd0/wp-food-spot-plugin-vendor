...
interface AdapterInterface
{
    ...
    /**
     * Returns a new Onepix\FoodSpotVendor\Phinx\Db\Table\Column using the existent data domain.
     *
     ...
     *
     * @param \Onepix\FoodSpotVendor\Phinx\Migration\MigrationInterface $migration The migration target for the breakpoint set
     * @return $this
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Phinx\Migration\MigrationInterface $migration The migration target for the breakpoint unset
     * @return $this
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Phinx\Db\Table\Table $table The table to execute the actions for
     * @param \Onepix\FoodSpotVendor\Phinx\Db\Action\Action[] $actions The table to execute the actions for
     * @return void
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Phinx\Db\Table\Table $table Table where to insert data
     * @param array $row Row
     * @return void
     */
     ...
     * @param \Onepix\FoodSpotVendor\Phinx\Db\Table\Column[] $columns List of columns in the table
     * @param \Onepix\FoodSpotVendor\Phinx\Db\Table\Index[] $indexes List of indexes for the table
     * @return void
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Phinx\Util\Literal|string $type Type
