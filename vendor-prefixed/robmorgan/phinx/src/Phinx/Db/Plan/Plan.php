...
use Onepix\FoodSpotVendor\Phinx\Db\Plan\Solver\ActionSplitter;
...
class Plan
{
     ...
     *
     * @var \Onepix\FoodSpotVendor\Phinx\Db\Plan\NewTable[]
     */
     ...
     *
     * @var \Onepix\FoodSpotVendor\Phinx\Db\Plan\AlterTable[]
     */
     ...
     * Constructor
     *
     * @param \Onepix\FoodSpotVendor\Phinx\Db\Plan\Intent $intent All the actions that should be executed
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Phinx\Db\Action\Action[] $actions The actions to use for the plan
     * @return void
     */
     ...
     *
     * @return \Onepix\FoodSpotVendor\Phinx\Db\Plan\AlterTable[][]
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Phinx\Db\Adapter\AdapterInterface $executor The executor object for the plan
     * @return void
     */
     ...
     * rest
     *
     * @param \Onepix\FoodSpotVendor\Phinx\Db\Table\Table $table The table to find in the list of actions
     * @param \Onepix\FoodSpotVendor\Phinx\Db\Plan\AlterTable[] $actions The actions to transform
     * @return \Onepix\FoodSpotVendor\Phinx\Db\Plan\AlterTable[] The list of actions without actions for the given table
     */
     ...
     * given AlterTable.
     *
     * @param \Onepix\FoodSpotVendor\Phinx\Db\Plan\AlterTable $alter The collection of actions to inspect
     * @return \Onepix\FoodSpotVendor\Phinx\Db\Plan\AlterTable The updated AlterTable object. This function
     ...
     *
     * @param \Onepix\FoodSpotVendor\Phinx\Db\Action\Action[] $actions The actions to parse
     * @return void
     */
