...
namespace Onepix\FoodSpotVendor\Phinx\Db\Plan\Solver;

use Onepix\FoodSpotVendor\Phinx\Db\Plan\AlterTable;
...
class ActionSplitter
{
     ...
     * @return \Onepix\FoodSpotVendor\Phinx\Db\Plan\AlterTable[] A list of AlterTable that can be executed without
