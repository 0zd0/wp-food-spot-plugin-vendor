...
use Onepix\FoodSpotVendor\Phinx\Config\ConfigInterface;
use Onepix\FoodSpotVendor\Phinx\Config\NamespaceAwareInterface;
use Onepix\FoodSpotVendor\Phinx\Console\Command\AbstractCommand;
use Onepix\FoodSpotVendor\Phinx\Migration\Manager\Environment;
use Onepix\FoodSpotVendor\Phinx\Seed\AbstractSeed;
use Onepix\FoodSpotVendor\Phinx\Seed\SeedInterface;
...
class Manager
{
    ...
    /**
     * @var \Onepix\FoodSpotVendor\Phinx\Config\ConfigInterface
     */
    ...
    /**
     * @var \Onepix\FoodSpotVendor\Phinx\Migration\Manager\Environment[]
     */
    protected array $environments = [];

    /**
     * @var \Onepix\FoodSpotVendor\Phinx\Migration\MigrationInterface[]|null
     */
    protected ?array $migrations = null;

    /**
     * @var \Onepix\FoodSpotVendor\Phinx\Seed\SeedInterface[]|null
     */
    protected ?array $seeds = null;

    /**
     * @var \Onepix\FoodSpotVendor\Psr\Container\ContainerInterface
     */
    ...
    /**
     * @param \Onepix\FoodSpotVendor\Phinx\Config\ConfigInterface $config Configuration Object
     * @param \Onepix\FoodSpotVendor\Symfony\Component\Console\Input\InputInterface $input Console Input
     * @param \Onepix\FoodSpotVendor\Symfony\Component\Console\Output\OutputInterface $output Console Output
     */
    ...
    public function printStatus(string $environment, ?string $format = null): array
    {
        ...
        if (count($migrations)) {
            ...
            /** @var \Onepix\FoodSpotVendor\Phinx\Migration\AbstractMigration[] $sortedMigrations */
            $sortedMigrations = [];
     ...
     * @param \Onepix\FoodSpotVendor\Phinx\Migration\MigrationInterface $migration Migration
     ...
     *
     * @param string $name Environment Name
     * @param \Onepix\FoodSpotVendor\Phinx\Seed\SeedInterface $seed Seed
     * @return void
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Phinx\Migration\Manager\Environment[] $environments Environments
     * @return $this
     */
     ...
     * @param string $name Environment Name
     * @throws \InvalidArgumentException
     * @return \Onepix\FoodSpotVendor\Phinx\Migration\Manager\Environment
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Psr\Container\ContainerInterface $container Container
     * @return $this
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Phinx\Migration\AbstractMigration[] $migrations Migrations
     * @return $this
     */
     ...
     * @param string $environment Environment
     * @throws \InvalidArgumentException
     * @return \Onepix\FoodSpotVendor\Phinx\Migration\MigrationInterface[]
     */
    public function getMigrations(string $environment): array
    {
        if ($this->migrations === null) {
            ...
            $fileNames = [];
            /** @var \Onepix\FoodSpotVendor\Phinx\Migration\AbstractMigration[] $versions */
            $versions = [];
     ...
     *
     * @param \Onepix\FoodSpotVendor\Phinx\Seed\SeedInterface[] $seeds Seeders
     * @return $this
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Phinx\Seed\SeedInterface $seed Seed
     * @return \Onepix\FoodSpotVendor\Phinx\Seed\SeedInterface[]
     */
     ...
     *
     * @param \Onepix\FoodSpotVendor\Phinx\Seed\SeedInterface[] $seeds Seeds
     * @return \Onepix\FoodSpotVendor\Phinx\Seed\SeedInterface[]
     */
    ...
    public function getSeeds(string $environment): array
    {
        if ($this->seeds === null) {
            ...
            // filter the files to only get the ones that match our naming scheme
            $fileNames = [];
            /** @var \Onepix\FoodSpotVendor\Phinx\Seed\SeedInterface[] $seeds */
            $seeds = [];
            ...
            foreach ($phpFiles as $filePath) {
                if (Util::isValidSeedFileName(basename($filePath))) {
                    ...
                    // instantiate it
                    /** @var \Onepix\FoodSpotVendor\Phinx\Seed\AbstractSeed $seed */
     ...
     * Gets the config.
     *
     * @return \Onepix\FoodSpotVendor\Phinx\Config\ConfigInterface
     */
