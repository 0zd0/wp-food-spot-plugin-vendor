...
class Blog extends AbstractModel
{
    ...
    protected $casts = [self::BLOG_ID => 'int', self::SITE_ID => 'int', self::REGISTERED => 'datetime', self::LAST_UPDATED => 'datetime', self::PUBLIC => 'bool', self::ARCHIVED => 'bool', self::MATURE => 'bool', self::SPAM => 'bool', self::DELETED => 'bool', self::LANG_ID => 'int'];
