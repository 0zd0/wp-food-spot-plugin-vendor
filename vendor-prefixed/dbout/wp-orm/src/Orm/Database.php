...
use Onepix\FoodSpotVendor\Dbout\WpOrm\Orm\Query\Grammars\WordPressGrammar;
use Onepix\FoodSpotVendor\Dbout\WpOrm\Orm\Query\Processors\WordPressProcessor;
use Onepix\FoodSpotVendor\Dbout\WpOrm\Orm\Schemas\WordPressBuilder;
use Onepix\FoodSpotVendor\Illuminate\Database\Connection;
use Onepix\FoodSpotVendor\Illuminate\Database\LostConnectionException;
use Onepix\FoodSpotVendor\Illuminate\Database\QueryException;
...
class Database extends Connection
{
    ...
    {
        if (!self::$instance instanceof \Onepix\FoodSpotVendor\Dbout\WpOrm\Orm\Database) {
     ...
     * @inheritDoc
     */
    public function getSchemaBuilder(): \Onepix\FoodSpotVendor\Illuminate\Database\Schema\Builder
    {
