...
use Onepix\FoodSpotVendor\GuzzleHttp\Handler\CurlHandler;
use Onepix\FoodSpotVendor\GuzzleHttp\Handler\CurlMultiHandler;
use Onepix\FoodSpotVendor\GuzzleHttp\Handler\Proxy;
use Onepix\FoodSpotVendor\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
    ...
    public static function debugResource($value = null)
    {
        ...
        return \Onepix\FoodSpotVendor\GuzzleHttp\Psr7\Utils::tryFopen('php://output', 'w');
    }
    /**
     ...
     *
     * @return callable(\Onepix\FoodSpotVendor\Psr\Http\Message\RequestInterface, array): Promise\PromiseInterface Returns the best handler for the given system.
     *
