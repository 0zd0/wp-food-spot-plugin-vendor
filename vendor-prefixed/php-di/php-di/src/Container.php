...
use Onepix\FoodSpotVendor\DI\Definition\Resolver\ResolverDispatcher;
use Onepix\FoodSpotVendor\DI\Definition\Source\DefinitionArray;
use Onepix\FoodSpotVendor\DI\Definition\Source\MutableDefinitionSource;
use Onepix\FoodSpotVendor\DI\Definition\Source\ReflectionBasedAutowiring;
use Onepix\FoodSpotVendor\DI\Definition\Source\SourceChain;
use Onepix\FoodSpotVendor\DI\Definition\ValueDefinition;
use Onepix\FoodSpotVendor\DI\Invoker\DefinitionParameterResolver;
use Onepix\FoodSpotVendor\DI\Proxy\ProxyFactory;
use InvalidArgumentException;
use Onepix\FoodSpotVendor\Invoker\Invoker;
use Onepix\FoodSpotVendor\Invoker\InvokerInterface;
use Onepix\FoodSpotVendor\Invoker\ParameterResolver\AssociativeArrayResolver;
use Onepix\FoodSpotVendor\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
...
class Container implements ContainerInterface, FactoryInterface, InvokerInterface
{
     ...
     *                             The array can also contain DI definitions, e.g. \Onepix\FoodSpotVendor\DI\get().
     *
